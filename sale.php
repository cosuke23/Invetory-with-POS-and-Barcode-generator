            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">SELL ITEM</h1>
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Transaction</h3></div>
                    <div class="panel-body">
                    <form action="sale_process.php" method="POST" NAME = "frmOne" id="defaultForm">
                      <?php
                      ...
                      ?>
                      <div class="row">
                       <input type="hidden" name="username" value="<?php echo $studname; ?>"/>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                           <h5 style="padding-left:5px;">Product</h5>
                           <div class="form-group has-feedback">
                              <select class="form-control" onkeyup="OnChange(this.value)" name="product" id="product" required>
                                 <?php
                      $q_data = mysqli_query($conn,"SELECT *  FROM products");
                      foreach($q_data AS $qDAta){
                        ?>
                <option value="<?php echo $item_id = $qDAta['product_price']; ?>"><?php echo $item_id = $qDAta['product_name']; ?></option>
                               <?php
                             }
                             ?>
                      ...
                      <div class="row">
                         ...
                         <div class="col-md-2">
                             <h5 style="padding-left:5px;">ITEM Price</h5>
                              <div class="form-group has-feedback">
                                <input type="number" onkeyup="OnChange(this.value)" name="cost" id="cost" class="form-control" maxlength="3" readonly />
                             ...
                             <h5 style="padding-left:5px;">Total</h5>
                              <div class="form-group has-feedback">
                                <input type="number" onkeyup="OnChange(this.value)" name="total" id="total" class="form-control" maxlength="3" readonly />
                              </div>
                          </div>
                      </div>
<!--<div class="my-form">
...
<!-- custom -->
  ...
  var t1=0; var cost=0; var qty=0; product=0;
  qty = document.frmOne.qty.value;
  product = document.frmOne.product.value;
  cost = document.frmOne.cost.value;
  t1 = document.frmOne.total.value;
    function OnChange(value){
    
    qty = document.frmOne.qty.value;
    cost = document.frmOne.product.value;
