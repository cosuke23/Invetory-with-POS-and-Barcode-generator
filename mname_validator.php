          ...
          <section class="wrapper">
          	...
          	<div class="row">
				...
				<h3><b>Student Registration</b></h3>
                      ...
                      <form class="form-inline" role="form" method="POST" action="mname_validator_process.php">    
					...
					<div class="form-group">
                              <h4>Middle name:</h4>
								...
								if(isset($_GET['error']))
								{
									print '<div><label style="font-size:14px;color:red;">&nbsp;<b>Invalid info.</b></label></div>';
								}
								?>
                          ...
                          <div>
						  <button type="submit" name="btn_mname" class="btn btn-theme">Validate</button>
						  </div>
					  </form>
          			</div><!-- /form-panel -->
          		</div><!-- /col-lg-12 -->
