              ...
              <div class="sub-left-menu scroll">
                    ...
                    <br>
                      ...
                      <div class="nav-side-menu">
                        ...
                        <?php
                        if($usertype == 1){
                          echo '<label class="active"><a href="e2e_user_account.php">
          ...
          <!-- start: Content -->
            <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown" style="padding-left:10px;">
                           View and manage the user account info.
                        </p>
                    </div>
                </div>
              </div>
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>UPDATE USER ACCOUNT INFO</h3></div>
                    <div class="panel-body">
                    <form action="e2e_update_user_account_process.php" method="POST">
                      <?php
                        if(isset($_GET['user_id'])){
                          $user_id = $_GET['user_id'];
                          $q_user_info = $database->query("SELECT * FROM user_info WHERE user_id = '$user_id'");
                          foreach($q_user_info AS $qData){
                            $lname = $qData["lname"];
                            $fname = $qData["fname"];
                            $mname = $qData["mname"];
                            $title = $qData["title"];
                            ...
                            $contact_no = $qData["contact_no"];
                            $profileData = $qData["profileData"];
                            $usertype = $qData["usertype"];
                            $status = $qData["status"];
                      ...
                      <div class="row">
                        <div class="col-md-2">
                        <?php 
                            echo '<img src="data:'.$img_type_profile.';base64,'.$profileData.'" class="img-circle" alt="user name" style="width:150px;height:150px;">';
                        ?>
                        </div>
                        <div class="col-md-5">
                          <h4>Name: <?php echo $title." ".$lname.", ".$fname." ".$mname; ?></h4>
                        </div>
                        <div class="col-md-5">
                          <h4>User Number: <?php echo $username; ?></h4>
                        </div>
                         <div class="col-md-5">
                          ...
                          <div class="col-md-3">
                            ...
                            if($usertype != 1){
                                echo '<select class="form-control" name="position">
                                       <option value="'.$usertype.'">'.$position.'</option>
                      ...
                      <br>
                       <div class="row">
                          ...
                          <div class="col-md-4" style="display:<?php echo $btn; ?>">
                               <button type="submit" class="btn btn-ripple btn-raised btn-block btn-primary"  name="btn_update_user_info" id="btn_update_user_info">
                                <span class="glyphicon glyphicon-floppy-saved"></span> &nbsp;SAVE
                               </button>
                           </div>
                            <div class="col-md-4">
                             <a href="e2e_user_account.php"><button type="button" class="btn btn-ripple btn-raised btn-block btn-info"><span class="glyphicon glyphicon-chevron-left"> &nbsp;BACK</span></button></a>
                           </div>
                          </div>
                     </div>
                     </form>
