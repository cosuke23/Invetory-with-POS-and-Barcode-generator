          ...
          <section class="wrapper ">
		   ...
		   <div style="padding-top:20px"  class="">
              ...
              <?php
                     ...
                     $info =mysql_query("SELECT sum(a.totalhours) as hours,sum(a.totalminutes) as minutes,a.studno,b.admin_id from dailyrecord a
                     left join admin_info b on b.student_id=a.studno  group by b.admin_id   ")or die(mysql_error());
      
              ?>

                <div class="control-group">
                                   
                        <button name="save" class="btn btn-info"><a href="admin_201_files.php"><i >BACK</i></a></button></span>
...
<br/> 
                      ...
                      <thead> 
                          ...
                          while($item_data=mysql_fetch_array($info)){
                            $stud = $item_data['admin_id'];
                          $studs = $item_data['studno'];
                        ...
                        <button name="check" class="btn btn-info"><i  class="fa fa-eye" aria-hidden="true" ></i></button></form>
                        <form method="post">
                                     <input type="hidden" value="<?php echo $studs; ?>" name="stud">
                        <button name="check" class="btn btn-info"><i  class="fa fa-eye" aria-hidden="true" ></i></button></form></td>
                      ...
                      <thead> 
                          ...
                          $infos =mysql_query("SELECT * from dailyrecord where studno='$stud'    ")or die(mysql_error());

                          while($item_data=mysql_fetch_array($infos)){
                          $date = $item_data['date'];
                          $stud = $item_data['studno'];
                          $time_end = $item_data['etime'];
                          $time_start = $item_data['stime'];
                          $remarks=$item_data['remark'];
                          ?>                  
