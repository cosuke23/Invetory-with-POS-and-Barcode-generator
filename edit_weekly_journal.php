						...
						<div class="col-lg-12 col-md-12 col-sm-12 mb">
						  <div class="weather-2">
							<div class="weather-2-header row">
									<div class="">
										<div class="col-sm-12 col-xs-12">
											<p style="font-size:25px;padding-top:7px;">EDIT WEEKLY JOURNAL ENTRY</p>
										</div>
						   ...
						   <?php
								...
								$entry_date1 = $_GET['weekly_journal_date'];
								...
								//get working hours
								$q_hrs = "select input_minutes from dtr where stud_no='$stud_no' and date_submitted='$entry_date1'";
								$q_hrs_res = $dbc->query($q_hrs);
								$hrs= $q_hrs_res->fetch_assoc();
								$total_hrs= intval($hrs['input_minutes'] / 60);
								$total_minutes = fmod($hrs['input_minutes'],60);
								//get student comp
								...
								//
								// get entry details
								$q_journal_entry ="select * from journal where stud_no='$stud_no' and semester='$stud_current_sem' and acad_year_start='$stud_current_acadyrstart' and type='Weekly' and date_submitted='$entry_date1'";
							...
							<form  action="update_weekly_journal.php" method="POST">
							...
							<textarea id="weekly_summary" name="weekly_summary" maxlength="255" class="form-control" rows=3><?php echo $journal_entry['journal_entry']; ?></textarea>
							</div>
							</div>
						</div>
							
							<div class="col-sm-7 col-xs-7">
							<button name="btn_update_weekly_journal" class="btn btn-primary" style="float:right;" type="submit">Update</button>
