          ...
          <div id="content" class="profile-v1">
            <div class="panel box-shadow-none content-header">
              <div class="panel-body">
                <div class="col-md-12">
                  <h1 class="animated fadeInLeft">SCHEDULED APPLICANTS</h1>
                </div>
              </div>
            </div>
            <div class="col-md-12 padding-0">
              <div class="col-md-12">
                <div class="panel">
                  <div class="panel-heading"><h3>List of all interview applicants</h3></div><br>
                    <div class="row">
                      <div class="col-md-12">

                        <div class="panel-body">
                          <!-- <div class="col-md-12">
                            <div class="row" style="background-color:#04ae09;color:#fff";>
                              <div class="col-md-6">
                                <h4><b><?php //echo date("h:i A",strtotime($time_start))." - ".date("h:i A",strtotime($time_end)); ?></b></h4>
                              </div>
                            </div>
                          </div><br> -->
                          <br>
                            ...
                            $status =   $q_mi_sched_data[8];                                                  
                                ...
                                ?>
                                    <tr>
                                      ...
                                      <td class="text-center" style="width:20%;">
                                        <a target="_blank" href="e2e_interviewee_available.php?mi_sched_stud_set_id=<?php echo $mi_sched_stud_set_id; ?>">
                                          <button type="submit" class="btn btn-success btn-md" style="background:#179965;">
                                          <span class="glyphicon glyphicon-check"></span> Start Interview</button>
                                        </a>
                                      </td>
                                    </tr>
                                    <?php
                                ...
                                ?>
                                    <tr>
                                      ...
                                      <td class="text-center"><?php echo $lname.", ".$fname." ".$mname; ?></td>
                                      <td class="text-center"><?php echo $program_code; ?></td>
                                      <td class="text-center" style="width:20%;color:#185ede;font-weight:bold;"><?php echo $status; ?></td>
                                    </tr>                                
                                <?php
                                  }
                                  elseif($status == 'Set'){
                                ?>
                                    <tr>
                                      ...
                                      <td class="text-center"><?php echo $lname.", ".$fname." ".$mname; ?></td>
                                      <td class="text-center"><?php echo $program_code; ?></td>
                                      <td class="text-center" style="width:20%;color:#ff8000;font-weight:bold;"><?php echo "No attendance yet"; ?></td>
                                    </tr>
                                <?php
                                  }
                                  else{
                                ?>
                                    <tr>
                                      ...
                                      <td class="text-center"><?php echo $lname.", ".$fname." ".$mname; ?></td>
                                      <td class="text-center"><?php echo $program_code; ?></td>
                                      <td class="text-center" style="width:20%;color:#e5133a;font-weight:bold;"><?php echo $status; ?></td>
                                    </tr>
                          <?php
                                  }
                            //     }
