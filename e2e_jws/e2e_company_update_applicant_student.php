            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">UPDATE APPLICANT</h1>
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading">
                     ...
                     <ul id="tabs-demo4" class="nav nav-tabs nav-tabs-v3" role="tablist">
                      ...
                      <li role="presentation" class="active">
                        <a href="#tabs-demo4-area2" role="tab" id="tabs-demo4-2" data-toggle="tab" aria-expanded="false">STUDENT INFO</a>
                      </li>
                    </ul>
                    </div>
                    <div class="row">
                    ...
                    <div class="panel-body">
                        <?php
                        if(isset($_GET['stud_no']) && isset($_GET['aljf_id'])){
                          $stud_no = $_GET['stud_no'];
                          $aljf_id = $_GET['aljf_id'];
                          $q_data = $database->query("SELECT a.lname,a.fname,a.mname,.a.stud_dp,b.program_code,a.contact_no,a.address,a.email FROM student_info AS a INNER JOIN program_list AS b INNER JOIN applicant_list_jf AS c where a.stud_no = c.stud_no AND c.aljf_id = '$aljf_id' AND a.stud_no = '$stud_no' AND a.program_id = b.program_id" );
                          ...
                          $q_data_al = $database->query("SELECT a.*,b.remarks,b.others,b.aljf_id FROM student_info AS a INNER JOIN applicant_list_jf AS b INNER JOIN event_manager AS c WHERE a.stud_no = b.stud_no AND a.stud_no = '$stud_no' AND b.comp_id = '$comp_id' AND b.event_id = c.event_id AND c.status = 'Active'");
                          foreach($q_data_al AS $qData_al){
                            $remarks = $qData_al['remarks'];
                             $others = $qData_al['others'];
                             $aljf_id = $qData_al['aljf_id'];
                          }
                        ?>
                       ...
                       <div class="row" style="background-color:#3385ff;">
                        ...
                        <form action="e2e_company_update_applicant_student_process.php" id="defaultForm" method="POST">
                          ...
                          <input type="hidden" name="aljf_id" value="<?php echo $aljf_id; ?>">
                          ...
                          <div class="row" style="display:<?php echo $show; ?>">
                            <div class="col-md-12" >
                              ...
                              <div class="col-md-5">
                                ...
                                <div class="form-group has-feedback">
                                  <input type="text" name="others" id="others" class="form-control" maxlength="200" placeholder="specify remarks"  value="<?php echo $others; ?>"/>
                                </div>
                               </div>
                              </div>
                            </div>
                            ...
                            <div class="col-md-4" style="display:<?php echo $show; ?>">
                                 <button type="submit" class="btn btn-ripple btn-raised btn-block btn-primary"  name="btn_update_applicant" id="btn_update_applicant">
                                  <span class="glyphicon glyphicon-pencil"></span> &nbsp;UPDATE
                                 </button>
                             </div>
                              <div class="col-md-4">
                               <a href="e2e_company_applicant_list.php"><button type="button" class="btn btn-ripple btn-raised btn-block btn-info"><span class="glyphicon glyphicon-chevron-left"> &nbsp;BACK</span></button></a>
                             </div>
                          </div>
                        </form>
                     </div>
