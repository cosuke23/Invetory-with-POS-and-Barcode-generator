              ...
              <div class="sub-left-menu scroll">
                    ...
                    <br>
                      ...
                      <div class="nav-side-menu">
                        ...
                        echo '<label class="active"><a href="audit_trail.php">
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">Audit Trail</h1>
                        <p class="animated fadeInDown" style="padding-left:10px;">
                           View Audit trail of the e2e system.
                        </p>
                    </div>
                </div>
              </div>
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Audit Trail Records</h3></div>
                      <br>
                    <div class="panel-body">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th class="text-center" style="width:60px;">TIME</th>
...
<script type="text/javascript">
 ...
 $('#datatables').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "e2e_audit_trail_processing.php",
        "order": [[ 5,6, "asc" ]],
