                ...
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading">
                      <h3>ADD TIME IN SESSION 1</h3>
                    </div>
                    <?php 
                    $q_tin = $database->count("seminar_attended","*",
                    ...
                    ?>
                      <form id="defaultForm" method="post" action="add_time_in1_process.php" enctype="multipart/form-data">
                      <div class="panel-body" style="padding-bottom:30px;">
                      <div class="row" style="background-color:#3385ff;">
                        <input type="hidden" name="s1_timein" value ="<?php echo $s1_timein; ?>">
                        <input type="hidden" name="event_id" value ="<?php echo $event_id; ?>">
                        <input type="hidden" name="s1_end" value ="<?php echo $s1_end; ?>">
                        ...
                        <div class="row">
                          <div class="col-md-8">
                            <h4>SESSION 1 START TIME : <?php echo date("h:i A",$s1_start); ?></h4>
                          </div>
                          <div class="col-md-4">
                              <h4>SESSION 1 TIME OUT : <?php echo date("h:i A",$s1_end); ?></h4>
                          </div>  
                        </div>
                            ...
                            <div class="col-md-12">
                                  <div class="col-md-4">
                                   <h5 style="padding-left:5px;">(S1)TIME IN</h5>
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $time_now; ?>" disabled>
                                    </div>
                                </div>
                              <div class="col-md-4">
                                 <h5 style="padding-left:5px;">(S1)TIME OUT</h5>
                                  <div class="form-group has-feedback">
                                  <input type="text" name="s1_timeout" id="s1_timeout" class="form-control" 
                                    value=" <?php echo date("h:i A",$s1_end); ?>" disabled>
                                  </div>
                              </div>
                              <div class="col-md-4">
                                 <h5 style="padding-left:5px;">(S1)STATUS</h5>
                                  <div class="form-group has-feedback">
                                  <input type="text" class="form-control" value="<?php echo $s1_status; ?>" disabled>
                                    <input type="hidden" name= "s1_status" value="<?php echo $s1_status; ?>">
                                  </div>
                              </div>   
                            </div> 
                          </div>
                       ...
                       <div class="row">
                            ...
                            <div class="col-md-4">
                                 <button type="submit" class="btn btn-ripple btn-raised btn-block btn-success"  name="btn_add_seminar_attended" id="btn_add_seminar_attended" style="display:<?php echo $btn_status; ?>">
