          ...
          <!-- start: Content -->
            <div id="content">
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Add New Event (Job Fair)</h3></div>
                    <br>
                    ...
                    <?php
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          ...
                          <div class="form-group has-feedback">
                          <input type="hidden" name="event_type" value="Job Fair">
                            <select class="form-control" name="event_type1" class="form-control" placeholder="" disabled="disabled">
                              <option></option>
                              <option value="Job Fair" selected="true">Job Fair</option>
