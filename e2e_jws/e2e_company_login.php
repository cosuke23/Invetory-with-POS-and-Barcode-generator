...
<head>
  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <body id="mimin" class="dashboard form-signin-wrapper3">
      <div class="container" style="margin-top:20px;">
        <div  class="form-signin">
          <div class="panel3 periodic-login">
            ...
            <form id="signupForm" method="POST" class="form-signin">
              <div class="form-group form-animate-text" style="margin-top:40px !important;" >             
                 <input type="text" class="form-text" id="validate_username" name="validate_username">
                          <span class="bar"></span>
                          <label class="customlabel">Username (e.g.CMP20160000)</label>
                        </div>
                        <div class="form-group form-animate-text" style="margin-top:40px !important;">
      ...
      success :  function(response)
         {            
          if(response=="ok"){
            ...
            setTimeout('window.location.href = "find_cookie_company_location.php"; ',1000);
          }else{
