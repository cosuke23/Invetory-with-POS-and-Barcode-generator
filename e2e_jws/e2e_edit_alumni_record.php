                  ...
                  <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        if(isset($_GET['stud_no'])){
                          ...
                          $q_data = $database->query("SELECT a.*,c.program_code,b.* FROM student_info AS a INNER JOIN program_list AS c INNER JOIN alumni_info AS b WHERE c.program_id = a.program_id AND b.stud_no = a.stud_no AND a.stud_no = '$stud_no'" )->fetchAll();
                          foreach($q_data AS $q_Data){
                            ...
                            $email = $q_Data['email'];
                            $work = $q_Data['work_status'];
                            $comp = $q_Data['comp_name'];
                            $work = $q_Data['work_status'];
...
<br>
     <div class="col-md-3" id="no_month_hired_grad">
        <SELECT name="industry"  class="form-control">
                                  ...
                                  $sel_admin = "SELECT * FROM section";
    $rs_admin = mysql_query($sel_admin);
    while($row = mysql_fetch_array($rs_admin)){ ?>
                                    <option value=""></option>
                                    <option value="<?php if(isset($_POST['services'])){$stud2 = $_POST['services']; echo $stud2;}?>">ACCOMMODATION AND FOOD SERVICES ACTIVITIES</option>
  ...
  <?php
            ...
            $message="";
              ...
              if(isset($_POST['btn']))
              {
                ...
                $q_data = $database->query("SELECT * FROM section AS a INNER JOIN services AS b  WHERE a.sec_type='$services' AND a.sec_type=b.section ");
                foreach($q_data AS $q_Data)
                {
              
                  $section = $q_Data['section'];
                  $s_division = $q_Data['s_division'];
                  $s_class = $q_Data['s_class'];
                  $s_type = $q_Data['s_type'];
                  $s_sub = $q_Data['s_sub'];
               ...
               <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group has-feedback">
                                  <input type="text" name="division" class="form-control" maxlength="200" value="<?php echo $s_division; ?>" placeholder="Division"  />
                                </div>
                               </div>
                                   <div class="col-md-3" id="position">
                                <h5 style="padding-left:5px;">Sub Class</h5>
                                <div class="form-group has-feedback">
                                  <input type="text" name="sub_class" class="form-control" maxlength="200" value="<?php echo $s_sub; ?>" placeholder="Sub-Class"  />
                                </div>
                               </div>
