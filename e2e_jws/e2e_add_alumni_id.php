                  ...
                  <div class="panel">
                    ...
                    <div class="panel-body">
                       ...
                       <div class="row" style="background-color:#3385ff;">
                        ...
                        <form action="e2e_add_alumni_info_id_process.php" id="defaultForm" method="POST">
                          ...
                          <div class="row">
                                ...
                                <div class="form-group">
                                  <div class="dateContainer">
                                      <div class="input-group input-append date" id="claimed_date">
                                          <input type="text" class="form-control" name="claimed_date" maxlength="10"/>
                                          <span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
                                      </div>
                                  </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                 <button type="submit" class="btn btn-ripple btn-raised btn-block btn-success"  name="btn_add_alumni_info_id" id="btn_add_alumni_info_id">
