              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <form id="batch_certi" method="post" action="e2e_student_records.php" enctype="multipart/form-data">
                                  <div class="row">
                                    <div class="col-md-2">
                      ...
                      <thead>
                       ...
                       <?php
                                    ...
                                    $program_code2 = $_GET['program_code'];
                                      $q_data = mysql_query("SELECT * from student_info where year='$program_code2'
")or die(mysql_error());
