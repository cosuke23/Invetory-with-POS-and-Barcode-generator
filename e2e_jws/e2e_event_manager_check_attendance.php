          ...
          <div class="container-fluid mimin-wrapper">
            ...
            <div id="content">
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>CHECK ATTENDANCE (Under Development)</h3></div>
                    <?php
                      ...
                      if(isset($_GET['event_id'])) {
                        ...
                        $table = "event_manager";
                        $columns = ["event_code","event_name","event_date","no_session","type","semester","acad_year_start_seminar",
                          "acad_year_end_seminar","s1_start","s1_end","s2_start","s2_end"];
