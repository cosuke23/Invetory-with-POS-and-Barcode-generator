                ...
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading">
                      <h3><?php if(isset($_GET['remarks'])){ echo $_GET['remarks']; } ?></h3>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                      ...
                      <tbody>
                        <?php
                          if(isset($_GET['remarks'])){
                            ...
                            $q_remarks = $database->select($table, $columns, $where);

                            foreach ($q_remarks AS $q_remarks_data) {
                              $comp_id = $q_remarks_data["comp_id"];
                              $remarks = $q_remarks_data["remarks"];

                              $table2 = "company_info";
                              $columns2 = "*";
                              $where2 = ["comp_id" => $comp_id];
                              $q_comp = $database->select($table2, $columns2, $where2);

                              foreach ($q_comp AS $q_comp_data) {
                                $comp_logo =   $q_comp_data['comp_logo'];
                                $comp_name = $q_comp_data["comp_name"];
                                $comp_address = $q_comp_data["comp_address"];
                                $status = $q_comp_data["status"];
                                $comp_dept = $q_comp_data["comp_dept"];
                          ...
                          ?>
                            <tr>
                              <td><?php echo '<img src="data:'.$type.';base64,'.$comp_logo.'" style="height:50px;width:60px;">'; ?></td>
                              <td><?php echo $comp_name ?></td>
                              <td><?php echo $comp_address ?></td>
                              <td><?php echo $status; ?></td>
                              <td><?php echo $comp_dept; ?></td>
