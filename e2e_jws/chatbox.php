                        ...
                        <div class="col-md-12">
                          ...
                          ?>
                            <ul class="nav nav-list">
                              <a href="chat_inbox_update_status.php?sender=<?php echo $sender; ?>" style="font-weight:normal;">
                                <li>
                          ...
                          ?>
                            <ul class="nav nav-list">
                              <a href="chat_inbox_update_status.php?sender_comp=<?php echo $sender; ?>" style="font-weight:normal;">
                                <li>
                                  <div class="panel-heading" style="background:#fff;">
                ...
                <div class="col-md-8">
                  ...
                  if(isset($_GET['user_id_clicked'])){
                    ...
                    foreach($q_user AS $q_user_data){
                      ...
                      $dp_img = base64_decode($dp);
                      $f = finfo_open();
                      $dp_type = finfo_buffer($f, $dp_img, FILEINFO_MIME_TYPE);
                  ?>
                  <div class="panel" id="chat">
                    <div class="panel-heading" style="background:#0084ff;">
                      <div style="font-size:18px;color:#fff;"><?php echo $full_name; ?>&nbsp;<?php echo '<img src="data:'.$dp_type.';base64,'.$dp.'" class="img-circle avatar">'; ?></div>
                          ...
                          <div class="chat-area-content">
                            <div class="msg_container_base">
                              ...
                              <div class="row msg_container <?php echo $type; ?>">
                                ...
                                elseif($sender == $receiver_user){
                                  echo '<img src="data:'.$dp_type.';base64,'.$dp.'" class="img-circle avatar">';
                                }
                                ?>
                              </div>
                              <?php
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          <div style="margin-right:10px;">
                            <button type="submit" class="btn btn-block btn-lg" name="btn" style="background:#0d47a1;color:#fff;"><span class="fa fa-chevron-circle-right fa-lg"></span></button>
                          </div>
                        </div>
                      </div>
                    </form>
                    ...
                    elseif(isset($_GET['comp_id_clicked'])){
                      ...
                      foreach($q_nop AS $q_nop_data){
                        ...
                        foreach($q_comp AS $q_comp_data){
                          ...
                          $company_receiver = $q_comp_data["username"];
                          $comp_logo = $q_comp_data["comp_logo"];

                          $decoded = base64_decode($comp_logo);
                          $x = finfo_open();
                          $comp_type = finfo_buffer($x, $comp_logo, FILEINFO_MIME_TYPE);
                  ?>
                  <div class="panel" id="chat">
                    <div class="panel-heading" style="background:#0084ff;">
                      <div style="font-size:18px;color:#fff;"><?php echo $comp_name; ?>&nbsp;<?php echo '<img src="data:'.$comp_type.';base64,'.$comp_logo.'" class="img-circle avatar">'; ?></div>
                      <div style="font-size:15px;color:#fff;"><?php echo $chat_status; ?></div>
                    </div>
                      ...
                      <div class="col-md-12 chatbox">
                        <div class="chat-area">
                          <div class="chat-area-content">
                            <div class="msg_container_base">
                              <?php
                              $q_chat = $database->query("SELECT * FROM messenger WHERE (sender='$sender_user' AND receiver='$company_receiver') OR (sender='$company_receiver' AND receiver='$sender_user')")->fetchAll();
                              foreach($q_chat AS $q_chat_data){
                                $message = $q_chat_data["message"];
                                $sender = $q_chat_data["sender"];
                                $receiver = $q_chat_data["receiver"];
                                ...
                                elseif($receiver == $company_receiver){
                                  $type = "receive";
                                }
                              ?>
                              <div class="row msg_container <?php echo $type; ?>">
                                <div class="col-md-9 col-xs-9 bubble">
                                  ...
                                  elseif($sender == $company_receiver){
                    ...
                    <form method="post" action="chat_send_process.php" id="add_company" enctype="multipart/form-data">
                      ...
                      <input name="sender" type="hidden" value ="<?php echo $sender_user; ?>" />
                      <input name="receiver" type="hidden" value ="<?php echo $company_receiver; ?>" />
                      <div class="row">
                        <div class="col-md-10">
                          <div class="form-group has-feedback">
                            <textarea rows ="2" name="message" class="form-control" placeholder="type your message here.." style="margin-left:10px;"></textarea>
                        ...
                        <div class="col-md-2">
                          <div style="margin-right:10px;">
                            <button type="submit" class="btn btn-block btn-lg" name="btn_comp" style="background:#0d47a1;color:#fff;"><span class="fa fa-chevron-circle-right fa-lg"></span></button>
                          </div>
                        </div>
                      </div>
                    </form>
