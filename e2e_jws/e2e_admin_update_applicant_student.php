            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">UPDATE APPLICANT FOR JOB FAIR</h1>
                  ...
                  <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        if(isset($_GET['stud_no']) && isset($_GET['aljf_id'])){
                          ...
                          $q_data = $database->query("SELECT a.lname,a.fname,a.mname,a.stud_dp,b.program_code,a.contact_no,a.address,a.email,c.comp_id,d.comp_name FROM student_info AS a INNER JOIN program_list AS b INNER JOIN applicant_list_jf AS c INNER JOIN company_info AS d where a.stud_no = c.stud_no AND c.aljf_id = '$aljf_id' AND a.stud_no = '$stud_no' AND a.program_id = b.program_id AND c.comp_id = d.comp_id" );
                        ...
                        <div class="row">
                          <div class="col-md-12" style="background-color:orange;">
                            <h4 style="color:white;"><?php echo $comp_name; ?></h4>
                          </div>
                        </div>
                       ...
                       <div class="row" style="background-color:#3385ff;">
                        ...
                        <form action="e2e_admin_update_applicant_student_process.php" id="defaultForm" method="POST">
                          ...
                          <div class="row" style="display:<?php echo $show; ?>">
                            ...
                            <div class="col-md-4" style="display:<?php echo $show; ?>">
                                 <button type="submit" class="btn btn-ripple btn-raised btn-block btn-primary"  name="btn_update_applicant_admin" id="btn_update_applicant_admin">
