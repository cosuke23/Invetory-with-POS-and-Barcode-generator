          ...
          <!-- start: Content -->
            <div id="content">
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>ADD USER ACCOUNT</h3></div>
                    <div class="panel-body">
                    <form action="e2e_add_user_account_process.php" method="POST" id="defaultForm">
                      <?php
                      $q_data = $database->query("SELECT max(user_id) AS user_id FROM user_info");
                      foreach($q_data AS $qDAta){
                          $user_id = $qDAta['user_id']+1;
                      }
                      $user_no = str_pad($user_id,4,'0',STR_PAD_LEFT);
                      $year_now = date("Y");
                      $username = "APO".$year_now.$user_no;

                      ?>
                      <div class="row">
                       <input type="hidden" name="username" value="<?php echo $username; ?>"/>
                        <div class="col-md-3">
                             <h5 style="padding-left:5px;">USER NUMBER</h5>
                      ...
                      <br>
                       <div class="row">
                          ...
                          <div class="col-md-4">
                               <button type="submit" class="btn btn-ripple btn-raised btn-block btn-primary"  name="btn_add_user_info" id="btn_add_user_info">
  ...
  $('#defaultForm')
        .bootstrapValidator({
            ...
            stringLength: {
                ...
                title: {
                    message: 'Honorific is invalid',
                    validators: {
                        notEmpty: {
                            message: 'Honorific is required and can\'t be empty'
                        },
                    }
                },
                email: {
                  ...
                  stringLength: {
                      ...
                      address: {
                          validators: {
                            ...
                            min: 10,
                            max: 250,
                            message: 'Address must be more than 10 and less than 250 characters long'
                        },
