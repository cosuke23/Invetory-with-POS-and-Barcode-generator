            ...
            <div id="content">
                      ...
                      <div class="panel-body" style="padding-bottom:30px;">
                        ...
                        <?php
                          ...
                          <div class="col-md-4">
                           ...
                           <h5>RESUME DATA &nbsp; <i class="fa fa-file-pdf-o"></i></h5>
                            <a href="asset/resume_data/<?php echo $file_name; ?>" style="font-size:20px;" target="resume">
                        ...
                        <div class="panel-body" style="height:750px;">
                          <div class="col-md-12" style="height:750px;">
                            <iframe name="resume" height="750px" width="100%"
              ...
              print '<div class="panel-body">
                      ...
                      foreach($q_sa1 as $seminar_attended_data){
                            ...
                            $date_attended = date("F d, Y",strtotime($seminar_attended_data['date_attended']));
              ...
              print '<div class="panel-body">
                      ...
                      foreach($q_sa2 as $seminar_attended_data){
                            ...
                            $date_attended2 = date("F d, Y",strtotime($seminar_attended_data['date_attended']));
              ...
              print '<div class="panel-body">
                      ...
                      <div role="tabpanel" class="tab-pane fade active in" id="tabs-demo3-area1" aria-labelledby="tabs-demo3-area1">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                           ...
                           <?php
                    $q_data_jf = $database->query("SELECT a.comp_id,a.comp_name,b.remarks,b.others,a.comp_address,a.contact_no,b.aljf_id FROM company_info AS a INNER JOIN applicant_list_jf AS b INNER JOIN event_manager AS c WHERE b.stud_no = '$stud_no' AND a.comp_id = b.comp_id AND b.event_id = c.event_id AND c.status = 'Active'")->fetchAll();
                    ...
                    print '<div class="panel-body">
                      ...
                      <tr>
                                ...
                                <a class=" btn btn-outline btn-danger" data-toggle="tooltip" data-placement="top" title="Remove Applicant" href="e2e_admin_remove_applicant_student.php?aljf_id=<?php echo $aljf_id; ?>&stud_no=<?php echo $stud_no; ?>"><span class="fa fa-remove"></span></a>
                                </td>
