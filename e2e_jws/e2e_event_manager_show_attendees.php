          ...
          <div class="container-fluid mimin-wrapper">
            ...
            <div id="content">
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>SHOW ATTENDEES (Under Development)</h3></div>
                    <?php
                      ...
                      if(isset($_GET['event_id'])) {
                        ...
                        $event_type = $database->get($table,$columns,$where);
                            ...
                            <div class="row" style="padding-top:10px;">
                              ...
                              <div class="panel-body">
                                    ...
                                    <thead>
                                      <tr>
                                       ...
                                       <th class="text-center">STUDENT NO.</th>
                                        <th class="text-center">SESS. 1 TIME-IN</th>
                                        <th class="text-center">SESS. 1 TIME-OUT</th>
                                        <th class="text-center">SESS. 1 STATUS</th>
                                        <th class="text-center">SESS. 2 TIME-IN</th>
                                        <th class="text-center">SESS. 2 TIME-OUT</th>
                                        <th class="text-center">SESS. 2 STATUS</th>
                                      </tr>
                                    </thead>
                                    <tbody>';

                                    $table = "seminar_attended";
                                    $join_clause = ["[>]seminar_attended_2"=>["sa_id"=>"sa_id"]];
                                    $columns = ["seminar_attended.stud_no",
                                                "seminar_attended.s1_timein",
                                                "seminar_attended.s1_timeout",
                                                "seminar_attended.s1_status",
                                                "seminar_attended_2.s2_timein",
                                                "seminar_attended_2.s2_timeout",
                                                "seminar_attended_2.s2_status"
                                               ];
                                    $where = ["seminar_attended.event_id" => $event_id];
                                    $seminar_datas = $database->select($table,$join_clause,$columns,$where);
                                    foreach($seminar_datas as $seminar_data){
                                      $stud_no      =   $seminar_data['stud_no'];
                                      $s1_timein    =   $seminar_data['s1_timein'];
                                      $s1_timeout   =   $seminar_data['s1_timeout'];
                                      $s1_status    =   $seminar_data['s1_status'];
                                      $s2_timein    =   $seminar_data['s2_timein'];
                                      $s2_timeout   =   $seminar_data['s2_timeout'];
                                      $s2_status    =   $seminar_data['s2_status'];
                                   ...
                                   <tr>
                                     ...
                                     <td><?php echo  $s1_timein; ?></td>
                                     <td><?php echo $s1_timeout; ?></td>
                                     <td><?php echo $s1_status; ?></td>
                                     <td><?php echo $s2_timein; ?></td>
                                     <td><?php echo $s2_timeout; ?></td>
                                     <td><?php echo $s2_status; ?></td>


                                           <!-- <td>
                                               <a href="e2e_event_manager_update_event.php?event_id=<?php //echo $event_id; ?>">
                                           ...
                                           <td>
                                             <a href="e2e_event_manager_show_attendees.php?event_id=<?php //echo $event_id; ?>">
                                               <button type="submit" class="btn btn-outline btn-warning btn-block btn-sm">
                                               <span class="glyphicon icon-people"></span> &nbsp;Show Attendees &nbsp;</button>
                                               </a>
                                           </td> -->
                          ...
                          else if($event_type=="Job Fair"){
                            echo $event_type . " 2nd cond.";
                          }
                          else if($event_type=="Mock Interview"){
                            echo $event_type . " 3rd cond.";
                          }
                      }
