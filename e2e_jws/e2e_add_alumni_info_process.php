...
if(isset($_POST['btn_add_alumni_info']))
	{
	...
	$qData = $database->insert($table,$columns)or die (mysql_error());

		if($qData==true){
			echo "okay";
		}
		header("location: e2e_update_student_records.php?success_alumni_2=1&stud_no=$stud_no&student_name=$student_name");
	}
?>