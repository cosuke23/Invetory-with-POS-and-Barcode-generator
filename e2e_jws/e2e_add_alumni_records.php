...
$date_contacted_default =  date("m/d/Y");
                  ...
                  <div class="panel">
                    ...
                    <div class="panel-body">
                       ...
                       <div class="row" style="background-color:#3385ff;">
                        ...
                        <form action="e2e_add_alumni_info_process.php" id="defaultForm" method="POST">
                          ...
                          <div class="row">
                                ...
                                <div class="form-group">
                                  <div class="dateContainer">
                                      <div class="input-group input-append date" id="date_contact">
                                          <input type="text" class="form-control" name="date_contact" maxlength="10" value= "<?php echo $date_contacted_default; ?>"/>
                           ...
                           <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group has-feedback">
                                  <textarea rows="2" name="comp_address" id="comp_address" class="form-control"></textarea>
                                </div>
                            </div>
                          </div>
                           ...
                           <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group has-feedback">
                                  <input type="text" name="position" class="form-control" maxlength="200" placeholder="Position"  />
                                </div>
                               </div>
                                ...
                                <div class="form-group">
                                  <div class="dateContainer">
                                      <div class="input-group input-append date" id="date_hired">
                                          <input type="text" class="form-control" name="date_hired" maxlength="10"/>
                                          <span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
                                      </div>
                                  </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group has-feedback">
                                  <input type="text" name="division" class="form-control" maxlength="200" placeholder="Division"  />
                                </div>
                               </div>
                                   <div class="col-md-3" id="position">
                                <h5 style="padding-left:5px;">Sub Class</h5>
                                <div class="form-group has-feedback">
                                  <input type="text" name="sub_class" class="form-control" maxlength="200" placeholder="Sub-Class"  />
                                </div>
                               </div>
                                ...
                                <div class="form-group has-feedback">
                                  <input type="text" name="remarks" class="form-control" maxlength="200" placeholder="Remarks"  />
                                </div>
                               </div>
                               ...
                               <div class="col-md-3" id="industry" >
                                ...
                                <div class="form-group has-feedback">
                                  <SELECT name="industry""  class="form-control">
                                    <option value=""></option>
                                    <option value="1">ACCOMMODATION AND FOOD SERVICES ACTIVITIES</option>
                                    <option value="2">ARTS, ENTERTAINMENT AND RECREATION</option>
                                    <option value="3">EDUCATION</option>
                                    <option value="4">FINANCIAL AND INSURANCE ACTIVITIES</option>
                                    <option value="5">HUMAN HEALTH AND SOCIAL WORK ACTIVITIES</option>
                                    <option value="6">INFORMATION AND COMMUNICATION</option>
                                    <option value="7">PROFESSIONAL, SCIENTIFIC AND TECHNICAL ACTIVITIES</option>
                                    <option value="8">REAL ESTATE ACTIVITIES</option>
                                    <option value="9">WHOLESALE & RETAIL TRADE, REPAIR OF MOTOR VEHICLES, MOTORCYCLES & MOTORCYCLES</option>
                                    <option value="10">TRANSPORT AND STORAGE</option>
                                    <option value="11">ADMINISTRATIVE AND SUPPORT SERVICE ACTIVITIES</option>
                                    <option value="12">PUBLIC ADMINISTRATION AND DEFENCE, COMPULSORY SOCIAL SECURITY</option>
                                    <option>OTHER SERVICE ACTIVITIES</option>
                                    <option>ACTIVITIES OF HOUSEHOLDS AS EMPLOYERS, UNDIFFERENTIATED GOODS-AND SERVICES-PRODUCING ACTIVITIES OF HOUSEHOLDS FOR OWN USE</option>
                                    <option>ACTIVITIES OF EXTRATERRITORIAL ORGANIZATION AND BODIES</option>
                            ...
                            <div class="col-md-4">
                                 <button type="submit" class="btn btn-ripple btn-raised btn-block btn-success"  name="btn_add_alumni_info" id="btn_add_alumni_info">
