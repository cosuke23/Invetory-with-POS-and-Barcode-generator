          ...
          <div id="left-menu">
            <div class="sub-left-menu scroll">
                    ...
                    <div class="profile-v1-pp">
					 ...
					 <a class="user-name">&nbsp; Hi' <?php echo  $title." ".$fname." ".$mname." ".$lname ?>&nbsp;</a> 
                      <h4 style="color:black;padding-left:60px;">Administrator</h4>
                    </div>
					
                    <div  style="margin-top:-20px;background: linear-gradient(#ebebe0, 50%,#ebebe0);height:20px;">
                    <br>
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">ADD STOCKS</h1>
                    </div>
                </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Add New Event (Seminar)</h3></div>
                    <br>
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          ...
                          <input type="hidden" name="event_type" value="Seminar">
                            <select class="form-control" name="event_type1" class="form-control" placeholder="" disabled="disabled">
                              <option></option>
                              <option value="Job Fair">Job Fair</option>
                              <option value="Seminar" selected="true">Seminar</option>
