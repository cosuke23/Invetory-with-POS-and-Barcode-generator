...
<html class="no-js">
    <head>
        ...
        <!-- Bootstrap -->
			...
			<link href="bootstrap/css/activitys.css" rel="stylesheet" media="screen">
			...
			<link href="assets1/styles.css" rel="stylesheet" media="screen">
		...
		<!-- data table -->
		<link href="assets1/DT_bootstrap.css" rel="stylesheet" media="screen">
		<!-- notification  -->
