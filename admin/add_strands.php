...
if(isset($_POST['btn-signup'])){
               $club = $_POST['strand']; 
               $class_id = $_POST['acro'];  
 $user_query = mysql_query("SELECT * from strands where id='$id'")or die(mysql_error());
...
$check_count=mysql_num_rows($user_query);
	...
	if($check_count<1){
        ...
        $c_img='sample.png';
        $data='';
        mysql_query("INSERT into strands  (strand,acronym)
                      values('".$club."','".$class_id."') ") or die (mysql_error());
...
$check_count=mysql_num_rows($user_query); ?>
								<form id="add_student" method="post">
								        ...
								        <div class="control-group">
                                          ...
                                          <div class="controls">
<input name="strand" class="input focused" id="focusedInput" type="text" placeholder = "Strand Name" placeholder="Strand" required>
                                          </div>
                                        </div>
                    <div class="control-group">
                                          <div class="controls">
                                            <input name="acro" class="input focused" id="focusedInput" type="text" placeholder="Acronym"  required>
                                          </div>
                                        </div>								
