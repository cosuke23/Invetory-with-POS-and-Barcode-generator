                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Teachers</strong>
										...
										<?php 
								$query_student = mysql_query("select * from students")or die(mysql_error());
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Section</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Handouts</strong>
