                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Moderator Users List</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form action="delete_users.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = mysql_query("SELECT * from admin left join schedule on admin.admin_id=schedule.stud_no")or die(mysql_error());
												...
												<td><?php echo $row['username']; ?> <?php echo $row['name']; ?></td>
