   <div class="row-fluid">
   <a href="staff_user.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Staff</a>
                        <!-- block -->
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = mysql_query("select * from staff where user_id = '$get_id'")or die(mysql_error());
...
mysql_query("update staff set username = '$username'  , firstname = '$firstname' , lastname = '$lastname' where user_id = '$get_id' ")or die(mysql_error());
