...
if(isset($_POST['btn_gen_data'])){
	...
	$tbl = "audit_trail";
 	$columns = ["date_at"=>$date_today,"time"=>$time_now,"username"=>$username,"action"=>"Generate Business Card : ".$stud_no."","module"=>"Business Card Module"];
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		if(isset($_POST['b_card_theme'])){
			$theme=$_POST['b_card_theme'];
		// $theme="puzzle";
			if($theme=="puzzle"){
				$img_file = K_PATH_IMAGES.'puzzle_theme.png';
			} else if($theme=="box"){
				$img_file = K_PATH_IMAGES.'box_theme.png';
			} else if($theme=="abstract"){
				$img_file = K_PATH_IMAGES.'abstract_theme.png';
			} else if($theme=="colorful_box"){
				$img_file = K_PATH_IMAGES.'colorful_box_theme.png';
			}
		}
