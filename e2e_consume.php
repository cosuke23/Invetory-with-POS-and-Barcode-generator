            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">CONSUMABLE MANAGER</h1>
                        <p class="animated fadeInDown" style="padding-left:10px;" >
                           Releasing Items in e2e office.
                        </p>                                                        
              
                    <ul id="tabs-demo3" class="nav nav-tabs nav-tabs-v3" role="tablist">
                        <li role="presentation" class="active">
                        <a href="#tab1" id="tabs1" role="tab" data-toggle="tab" aria-expanded="true"><span class="glyphicon glyphicon-list-alt"></span> CONSUMABLE STOCKS</a>
                      </li>
                        <li role="presentation">
                        <a href="#tab2" id="tabs2" role="tab" data-toggle="tab" aria-expanded="false"><span class="glyphicon glyphicon-list-alt"></span> RELEASE </a>
                      </li>				  
                    </ul>  
                      </div><!-- col-md-12 -->
                </div><!-- panel-body -->
				...
				<!-- Javascript -->
                      ...
                      if(isset($_GET['delete_item'])&&isset($_GET['username'])){
                        ...
                        swal({
                         ...
                         function(isConfirm){
                           if (isConfirm) {
                             window.location.href="e2e_consume.php";
                           }
                         });
                     </script>';
                      }
                    ...
                    <div class="panel-body">
                      ...
                      <div role="tabpanel" class="tab-pane fade" id="tab2" aria-labelledby="tab2">                        
                        ...
                        <?php
                          $table = "item_info";
                          $columns = "*";
						  $where_em4 = ["itemtype"=>"Consumable"];
                          $q_item_info =$database->select($table,$columns,$where_em4);
                          print '<div class="panel-body">
                          <div class="responsive-table">
                          ...
                          <td>                          
						  &nbsp;&nbsp;&nbsp;&nbsp;<a href="e2e_release_stocks.php?Item_Number=<?php echo $username; ?>&&itemname=<?php echo $itemname; ?>" class=" btn btn-outline btn-danger" data-toggle="tooltip" data-placement="top" title="Release Item"><span class="glyphicon glyphicon-refresh"></span></a>
