                      ...
                      <thead>
                        <tr>
                         ...
                         <th class="text-center">STUDENT NUMBER</th>
                          ...
                          <th class="text-center">OJT ACTION</th>
                        </tr>
                      </thead>
                      <tbody>';
              ...
              if($percentage==100){
                      ...
                      <td><?php echo '<img src="../files/student_pics/'.$ongoing_stud_no.'.jpg" style="height:50px;width:60px;">';?></td> 
                                ...
                                <td class="text-center" style="font-size:25px;color:#0099ff;"><b><?php echo intval($percentage).'%' ; ?></b></td>
                                           <td>
                              <a href="update_Student_information.php?stud_no=<?php echo $ongoing_stud_no; ?>">
                                  <button type="submit" class=" btn btn-outline btn-primary" data-toggle="tooltip" title= "Update Info">
                                  <span class="glyphicon glyphicon-pencil"></span></button>
                                  </a>
                    <a href="student_ojt_details.php?stud_no=<?php echo $ongoing_stud_no; ?>">
                     ...
                     <a href="view_Student_information.php?stud_no=<?php echo $ongoing_stud_no; ?>">
