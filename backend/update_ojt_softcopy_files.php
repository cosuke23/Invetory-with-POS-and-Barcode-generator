            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">UPDATE OJT SOFTCOPY FILE</h1>
                        <p class="animated fadeInDown" style="padding-left:10px;">
                         This section can update OJT Softcopy file.
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>UPDATE OJT SOFTCOPY FILE</h3></div>
                     <form id="defaultForm" method="POST" action="update_ojt_softcopy_files_process.php" enctype="multipart/form-data">
                     <input type="hidden" name="file_nameC" value="<?php echo $file_name; ?>" />
                      <div class="panel-body" style="padding-bottom:30px;">
         
                         <div class="row">                
                         <div class="col-md-3"></div>
              						 <div class="col-md-6">
              						 <h4 style="padding-left:5px;">FILE NAME: &nbsp;<b><?php echo $file_name;?></b></h4>
                           <h4 style="padding-left:5px;">UPLOAD FILE:</h4>
						...
						<div class="row">
						 <div class="col-md-3"></div>
						 <div class="col-md-6">
                            <h4 style="padding-left:5px;">FILE DESCRIPTION:</h4>
                              <div class="form-group has-feedback"> 
                               <input class="form-control" value="<?php echo $file_id;?>" name="file_id" type="hidden"/>
                                <textarea name="file_desc" class="form-control"><?php echo $file_desc; ?></textarea>
                              </div>
                         </div>
						 </div>
                        ...
                        <br>
                           ...
                           <div class="col-md-4"></div>
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-info btn-block" name="btn-softcopy-update" id="btn-softcopy-update"><span class="glyphicon glyphicon-floppy-saved"></span> &nbsp;SAVE</button>
                             </div>
                             <div class="col-md-4">
                               <a href="ojtsoftcopy.php"><button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-chevron-left"> &nbsp;BACK</span></button></a>
                           </div>
                         </div>
  ...
  $(document).ready(function(){
    $('#datatables').DataTable();
        ...
        .bootstrapValidator({
            ...
            fields: {
             file_desc: {
                    message: 'File Description is not valid',
                    validators: {
                        notEmpty: {
                            message: 'File Description is required and can\'t be empty'
                        },
            stringLength: {
                            min: 5,
                            max: 100,
                            message: 'File Description must be more than 1 and less than 50 letters'
                        },
                         regexp: {
                            regexp: /^[a-zA-Z ]+$/,
                            message: 'File Description can only consist of letters'
                        }
                    }
                },
                fileToUpload: {
