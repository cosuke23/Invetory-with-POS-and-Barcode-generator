          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown" style="padding-left:10px;">
                           View and manage all of the OJT Offers that are offered by the companies.
                        </p>
                    </div>
                </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>List of all OJT OFFERS</h3></div>
                    <br>
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        print '<div class="col-md-12">
                          <div class="alert alert-info alert-dismissible fade in" role="alert">
                                ...
                                <strong>&nbsp;OJT Offers Sucessfully Updated!</strong>
                           </div></div>';
                        } 
                        ?>
                      </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    var table = $('#datatables').DataTable({
        ...
        "serverSide": true,
        "order": [[ 2, "asc" ]],
        "ajax": "ojt_offers_masterlist_processing.php",
        lengthMenu: [[10, 50, -1], [10, 50, "All"]],
        "createdRow": function ( row, data, index ) {
             if(data[4] == "Available") {
                $('td', row).eq(4).addClass('Available');
               }
              else if(data[4] == "Not Available") {
                $('td', row).eq(4).addClass('Not_Available');
               }
             }
    });
