              ...
              <div class="sub-left-menu scroll">
                    ...
                    <br>
                      ...
                      <div class="nav-side-menu">
                        <label>
                          <a href="admin_home.php"><i class="glyphicon glyphicon-home"></i>Home</a>
                        </label><br>
                        <label  class="active">
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">PARTNER COMPANY INFORMATION</h1>
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>VIEW PARTNER COMPANY INFORMATION</h3></div>
                     <form id="defaultForm" method="post" action="update_comp_cont_info_process.php" enctype="multipart/form-data">
                       <div class="panel-body" style="padding-bottom:30px;">
                        ...
                        <input name="img_type" type="hidden" value ="<?php echo $img_type ?>"/>
                        <div class="row">
                           <div class="col-md-3"> 
                           <?php 
						   ...
						   <div class="col-md-9">
							<button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo"><?php echo $count;?> Student(s) in this Company</button>
								<div id="demo" class="collapse">
									<?php
									while($r2 = mysqli_fetch_array($rsic))
									{
										$lnm = $r2[0];
										$fnm = $r2[1];
										$mnm = $r2[2];
										...
										print '<a href="view_Student_information.php?stud_no='.$stud_no.'" style="font-size:16px;">'.$stud_no.' - '.$lnm.', '.$fnm.' '.$mnm.'</a><br>';
									}
									?>
								</div>
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <div class="form-group has-feedback">
                                  <textarea rows ="2" name="comp_desc" id="comp_desc" class="form-control" placeholder="(Optional)Company Description" maxlength="255" disabled><?php echo $comp_desc; ?> </textarea>
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group has-feedback">
                                  <textarea rows ="2" name="address" id="address" class="form-control" placeholder="Company Address" maxlength="100" disabled><?php echo $address; ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                          ...
                          <div class="row">
                            <div class="col-md-3">
                             ...
                             <div class="col-md-3">
                                ...
                                <div class="form-group">
                                <div class="dateContainer">
                                      <h4><?php echo $date_expiry; ?></h4>
                                </div>
                            </div>
                            </div>
                          </div>
                           <div class="row">
                            <h2 style="margin-left:13px;">Contact info</h2>
                          </div>
                          <div class="row">
                            <div class="col-md-4">
                                <h5 style="padding-left:5px;">CONTACT PERSON</h5>
                                <div class="form-group has-feedback">
                                    <h4 style="padding-left:5px;"><?php echo $contact_person; ?></h4>
                                </div>
                            </div>
                            <div class="col-md-4">
						  ...
						  <div class="row">
                            ...
                            <div class="col-md-4">
								...
								<a href="update_comp_cont_info.php?comp_id=<?php echo $comp_id;?>">
                                  <div class="col-md-10 btn btn-outline btn-primary">
              ...
              <div class="panel box-shadow-none content-header">
               ...
               <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
					...
					<div class="row"><h3>LIST OF COMPANY PROGRAMS</h3>
					     
					<a href="company_manage_program.php?comp_id=<?php echo $comp_id;?>">
					
                                  <div class="col-md-3 btn btn-outline btn-primary">
					...
					<br>
                      ...
                      <div class="panel-body" style="padding-bottom:30px;">
                        ...
                        <div class="row">
                        <?php 
                           $query_comp_info_program_list = "SELECT a.comp_id,a.program_id,a.comp_program_status,c.program_code FROM company_program AS a INNER JOIN company_info AS b INNER JOIN program_list AS c WHERE a.program_id = c.program_id AND a.comp_id = b.comp_id AND a.comp_id = '$comp_id'";
               ...
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">OJT OFFERS</h1>
                        <p class="animated fadeInDown" style="padding-left:10px;">
                         &nbsp;
                        </p>
                    </div>
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading">
					<div class="row">
					<h3>LIST OF ALL OJT OFFERS OF COMPANY <label style="color:black;"><?php echo $comp_name; ?></label></h3>
					<a href="company_manage_program.php?comp_id=<?php echo $comp_id;?>">
					
                                  <div class="col-md-3 btn btn-outline btn-success">
								 
                                  <span class="glyphicon glyphicon-plus"></span> Add OJT Offers</div>
                      ...
                      <div class="panel-body" style="padding-bottom:30px;">
                        ...
                        <div class="row">
                       <?php
                     $query_OJT_offers = "SELECT a.comp_id,a.comp_name,b.ojt_title,b.ojt_desc,b.status,b.ojt_offers_id,c.program_code FROM company_info AS a INNER JOIN ojt_offers AS b INNER JOIN program_list AS c WHERE a.comp_id = b.comp_id AND b.program_id = c.program_id AND a.comp_id = '$comp_id'";
                     $result_ojt_offers = mysqli_query($dbc, $query_OJT_offers);
                     $num_rows = mysqli_num_rows($result_ojt_offers);
            print '<div class="panel-body">
                      <div class="responsive-table">
                      <table id="datatables_ojt_offers" class="table table-bordered table-hover table-condensed table-reflow" width="100%" cellspacing="0">
                      <thead>
                        <tr>
                            <th class="text-center col-md-2">OJT TITLE</th>
                      ...
                      <tbody>';
                        while($row = mysqli_fetch_array($result_ojt_offers)) {
                          $color = ($row['status'] == 'Not Available' ? $color  = "#ebebe0" : '');
                          $font = ($row['status'] == 'Not Available' ? $font  = "#6b6b47" : '');
                      ...
                      <tr style="<?php print 'background-color:' . $color . ';'; print 'color:' . $font; ?>">      
                              ...
                              <td class="col-md-2"><?php echo $ojt_title; ?></td>
                              <td class="col-md-3"><?php echo $ojt_desc; ?></td>
                              <td class="col-md-1"><?php echo $offer_status; ?></td>
                              <td class="col-md-1"><?php echo $program_code; ?></td>
                    ...
                    print '</tbody>
                     ...
                     ?> 
                     <input type="hidden" id="comp_name" value="<?php echo $comp_name; ?>">
                     </div>
            ...
            <div class="col-md-12 sub-mimin-mobile-menu-list animated fadeInLeft">
                <ul class="nav nav-list">
                    <li class="ripple">
                     ...
                     <li class="ripple">
                     <a href="Manage_course.php"><i class="glyphicon glyphicon-list-alt"></i>&nbsp; Manage Program</a>
                    </li>
                     <li class="ripple">
...
<script type="text/javascript">
  ...
  var table = $('#datatables_ojt_offers').DataTable();
  var comp_name = document.getElementById('comp_name').value;
 var buttons = new $.fn.dataTable.Buttons(table, {
     buttons: [
            {
                extend: 'excelHtml5',
                title: 'List of all OJT Offers of Company ' + comp_name,
