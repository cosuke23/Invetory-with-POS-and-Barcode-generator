            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">SECTION LIST of <?php  echo $program_code; ?></h1>
                        <p class="animated fadeInDown" style="padding-left:10px;">
                          This section will show all the section list of program <?php echo $program_code; ?>
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>UPDATE SECTION</h3></div>
                    <div class="row" style="padding-top:10px;">
                      ...
                      <div class="panel-body" style="padding-bottom:30px;">
                        <div class="row">
                        <?php 
                           $query_section_list = "SELECT * FROM section_list WHERE program_id = '$program_id' AND section_id != '1'";
                          $result_section_list = mysqli_query($dbc, $query_section_list);
                          $num_rows = mysqli_num_rows($result_section_list);
                          ...
                          <tbody>';
                        while($row = mysqli_fetch_array($result_section_list)) {
                          $color = ($row['status'] == 'Not Active' ? $color  = "#ebebe0" : '');
                          $font = ($row['status'] == 'Not Active' ? $font  = "#6b6b47" : '');
                            $section_id = $row[0];
                            $sl_program_id = $row[1];
                            $section = $row[2];
                            $section_status = $row[3];
                           
                      ?>
                     <tr style="<?php print 'background-color:' . $color . ';'; print 'color:' . $font; ?>">      
                              <td><?php echo $section; ?></td>
                              <th><?php echo $section_status; ?></th>
                            
                               <?php
                               if($status == "Not Active")
                               {
                                print '<td>
                                        <a href="view_section_list.php?section_id='.$section_id.'">
                               ...
                               {
                                 print ' <td>
                                        <a href="update_section_list.php?section_id='.$section_id.'">
                                          <button type="submit" class=" btn btn-outline btn-primary btn-block btn-sm">
...
<script type="text/javascript">
  $(document).ready(function(){
   ...
   var program_code = document.getElementById('program_code').value;
 var buttons = new $.fn.dataTable.Buttons(table, {
     buttons: [
            {
                extend: 'excelHtml5',
                title: 'Section List' + " " + program_code,
