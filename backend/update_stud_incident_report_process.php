...
if (isset($_POST['btnupdateincidentreport'])){
		...
		if(!empty($name))
		{
			...
			$path = $_FILES['student_report']['name'];
			...
			die("<script language = javascript>
				...
				if(!empty($new_record)){
					...
					$filename = "../files/student_report/".$id.".pdf";
				...
				$filenamepo = $id .".pdf";
				$queryx = "UPDATE student_report SET filename = '$filenamepo', remarks = '$remarks',date ='$datetoday' WHERE id ='$id'";
		...
		{
				$queryx = "UPDATE student_report SET remarks = '$remarks',date ='$datetoday' WHERE id ='$id'";
				if(mysqli_query($dbc,$queryx))
				{
