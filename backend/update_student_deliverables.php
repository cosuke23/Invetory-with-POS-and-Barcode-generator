...
if($usertype!=1)
{
  ...
  $query_update_program_category_list = "SELECT deliverable_name, authorize_by FROM student_deliverables WHERE deliverable_id = '$deliverable_id' ";
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">STUDENT DELIVERABLE</h1>
                        <p class="animated fadeInDown" style="padding-left:10px;">
                          This section can update the student deliverable.
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>UPDATE STUDENT DELIVERABLE</h3></div>
                     <form id="defaultForm" method="post" action="update_student_deliverables_process.php">
                      <div class="panel-body" style="padding-bottom:30px;">
                        <input name="deliverable_id" type="hidden" value ="<?php echo $deliverable_id; ?>" />
                            ...
                            <div class="col-md-3">
                             ...
                             <div class="col-md-4">
                                <div class="form-group has-feedback">
                                  <input type="text" name="deliverable_name" id="deliverable_name" class="form-control" placeholder="Category Description" value="<?php echo $deliverable_name ; ?>"  maxlength="30"/>
                                </div>
                              </div>
                          ...
                          <br>
                           <div class="row">
                            ...
                            <div class="col-md-3">
                             ...
                             <div class="col-md-4">
                                <div class="form-group has-feedback">
                                  <select class="form-control" name="authorize_by" id="authorize_by" class="form-control">
								  <option value="<?php 
												...
												$comend = "-->";
													  if($authorize_by==1)
													  {
														$authorize_by_2="Admin";
														$comstart="<!--";
														echo $authorize_by_2;
													  }
													  if($authorize_by==2)
													  {
														$authorize_by_2="Adviser";
														$comstart2="<!--";
														echo $authorize_by_2;
													  }
												?></option>
								  <?php echo $comstart;?><option value="1">Admin</option><?php echo $comend;?>
								  <?php echo $comstart2;?><option value="2">Adviser</option><?php echo $comend;?>
								  </select>
                                </div>
                              </div>
                               <div class="col-md-4"></div>
                         ...
                         <div class="row">
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                  <button type="submit" class="btn btn-info btn-block" name="btn_update_student_deliverables" id="btn_update_student_deliverables"><span class="glyphicon glyphicon-floppy-saved"></span> &nbsp;SAVE</button>
                            </div>
                            <div class="col-md-4">
                                 <a href="student_deliverables.php"><button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-chevron-left"> &nbsp;BACK</span></button></a>
                            </div>
                          </div>
                          <br>
            ...
            stringLength: {
               ...
               category_description: {
                ...
                stringLength: {
                            min: 5,
                            max: 30,
                            message: 'OJT hours can be more than 5 and less than 30 alphanumeric characters'
                        },
                regexp: {
                            regexp: /^[a-zA-Z 0-9]+$/,
