                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown" style="padding-left:10px;">
                         This section can add a new OJT adviser information.
                        </p>
                    </div>
                  </div>
              </div>
                         ...
                         if(isset($_GET['error'])) 
                          ...
                          print '<div class="col-md-12" id="success">
                           <div class="alert alert-danger alert-dismissible fade in" role="alert">
                                  ...
                                  <strong>&nbsp;Error!</strong> The Selected Section Already Assigned!
                            </div></div>';
                          }
                        ?>
                        </div>
                      ...
                      <div class="panel-body" style="padding-bottom:30px;">
                         ...
                         <div class="col-md-2">
                          ...
                          <div class="col-md-1">
                               <h5 style="padding-left:5px;">STATUS</h5>
                                <div class="form-group has-feedback">
                                    <h4 style="padding-left:5px;"><?php echo $status; ?></h4>
                                     <input name="status_ash" type="hidden" value ="<?php echo $status; ?>"/>
                                </div>
                            </div>
                          <div class="col-md-4"> 
                              <h5 style="padding-left:5px;">ADVISER NAME</h5>
                          ...
                          <div class="col-md-3">
                           ...
                           <div class="col-md-2">
                            ...
                            <div class="form-group has-feedback">
                                <?php
                                $query_program_list = "SELECT * FROM program_list WHERE status = 'Active' AND program_id = '$program_id'";
                        ...
                        <br>
                            ...
                            <div class="col-md-12">
                                <div class="panel-body">
                                  <div class="well well-sm">
                                      ...
                                      <p> &nbsp;  &nbsp;  &nbsp; By the default of adding a new adviser, the<strong><mark class="text-primary">adviser ID </mark></strong> is also the password of the adviser. however, It can modified and update by the adviser.</p>
                                   </div>
                                </div>  
                          </div>
                        </div>
                          <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-success btn-block" name="btn_adviser_add2" id="btn_adviser_add1"><span class="glyphicon glyphicon-plus"></span> &nbsp;ADD </button>
                             </div>
