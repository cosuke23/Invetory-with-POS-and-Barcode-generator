                ...
                <div class="col-md-12">
                  ...
                  <div class="panel">
                    ...
                    <div class="panel-heading"><h3>MY WEEKLY JOURNAL</h3></div>
                      ...
                      $query_journal_week = "SELECT * FROM JOURNAL WHERE stud_no ='$stud_no' AND acad_year_start='$acad_year_start' AND semester = '$semester' AND type='Weekly'";
            ...
            print '<div class="panel-body">
                      ...
                      ?>
                       ...
                       <tr>                                     
                                ...
                                <td><?php echo $weekly_date; ?></td>

                              <td>

                                  <a href="weekly_journal.php?weekly_date=<?php echo $weekly_date; ?>&stud_no=<?php echo $stud_no; ?>&acad_year_start=<?php echo $acad_year_start; ?>&semester=<?php echo $semester; ?>">

                                  <button type="submit" class=" btn btn-default btn-block btn-sm">

                                  <span class="glyphicon glyphicon-pencil"></span> &nbsp; View</button>
