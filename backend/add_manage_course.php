            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">ADD NEW PROGRAM</h1>
                        <p class="animated fadeInDown" style="padding-left:10px;">
                         This section can add a new the program.
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>ADD NEW PROGRAM</h3></div>
                     <form id="defaultForm" method="post" action="add_Manage_course_info_process.php">
                      <div class="panel-body" style="padding-bottom:30px;">
                          <div class="row">
                            ...
                            <div class="col-md-3">
                               <h5 style="padding-left:5px;">PROGRAM CODE</h5>
                                <div class="form-group has-feedback">
                                  <input type="text" name="program_code" id="program_code" class="form-control" placeholder="Program code" maxlength="15" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h5 style="padding-left:5px;">PROGRAM NAME</h5>
                                <div class="form-group has-feedback">
                                  <textarea rows ="2" name="program_name" id="program_name" class="form-control" placeholder="program name" maxlength="100"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group has-feedback">
                                  <input type="text" name="section" id="section" class="form-control" placeholder="section" maxlength="15"/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel-body">
                                  <div class="well well-sm">
                                      ...
                                      <p> &nbsp;  &nbsp;  &nbsp; You can add <strong><mark class="text-primary">section</mark></strong> to this program in Manage Programs > Click "Update" > Update Section > Add.</p>
                                   </div>
                                </div>  
                          </div>
                        </div>
                         <div class="row">
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                  <button type="submit" class="btn btn-success btn-block" name="btn_add_course" id="btn-btn_add_course"><span class="glyphicon glyphicon-plus"></span> &nbsp;ADD</button>
                               </div>
                                 <div class="col-md-4">
   ...
   $('#defaultForm')
        .bootstrapValidator({
            ...
            stringLength: {
                            min: 3,
                            max: 15,
                            message: 'Program code must be more than 3 and less than 15 characters long'
                        },
                regexp: {
                            regexp: /^[a-zA-Z]+$/,
                ...
                program_name: {
                    validators: {
                        notEmpty: {
                            message: 'Program name is required and can\'t be empty'
                        },
                stringLength: {
                            min: 6,
                            max: 100,
                            message: 'Program name must be more than 6 and less than 100 characters long'
                        },
                        regexp: {
                            regexp: /^[a-zA-Z ]+$/,
                            message: 'Program name may only consist letters,'
                        },
                    }
                }, 
                section: {
                ...
                stringLength: {
                            min: 3,
                            max: 15,
                            message: 'Section must be more than 3 and less than 15 characters long'
                        },
                      regexp: {
                            regexp: /^[a-zA-Z \-=.!@#$%^&*()_+{}|<>:,/? 0-9]+$/,
                            message: 'Invalid characters'
