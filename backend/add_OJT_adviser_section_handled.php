...
if($usertype!=1)
{
  ...
  $query_update_OJT_adviser_section_handled ="SELECT a.adviser_id,a.lname,a.fname,a.mname,a.title,a.program_id,d.program_code FROM adviser_info AS a  INNER JOIN program_list AS d WHERE a.program_id = d.program_id  AND a.adviser_id = '$adviser_id'";
        ...
        <!-- start: Content -->
            <div id="content">
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>ADD SECTION HANDLED </h3></div>
                    <form id="defaultForm" method="post" action="add_ojt_adviser_section_handled_process.php">
                      <br>
                        <div class="col-md-12">
                         <?php 
                         if(isset($_GET['error'])) 
                          ...
                          <div class="col-md-12" id="success">
                           <div class="alert alert-danger alert-dismissible fade in" role="alert">
                                  ...
                                  <strong>&nbsp;Error!</strong> The Selected Section was Already Assigned!
                            </div>
                      ...
                      <br>
                        ...
                        <input name="adviser_id" type="hidden" value ="<?php echo $adviser_id; ?>"/>
                         ...
                         <div class="col-md-2">
                          ...
                          <div class="col-md-1"> 
                            ...
                            <div class="form-group">
                                  <h4>Active</h4>
                                  <input type="hidden" name="status_ash" value="Active">
                                </div>
                          </div>                    
                        </div>
                        ...
                        <br>
                         <div class="row">
                            ...
                            <div class="col-md-4">
                             <button type="submit" class="btn btn-success btn-block" name="btn_add_ojt_adviser_section_handled" id="btn_add_ojt_adviser_section_handled"><span class="glyphicon glyphicon-plus"></span> &nbsp;ADD</button>
                             </div>
                              <div class="col-md-4">
