...
if($usertype!=1)
{
  ...
  $query_Manage_course = "SELECT * FROM program_list where program_id ='$program_id' ";
                 
  $result_manage_course =  mysqli_query($dbc, $query_Manage_course);          
          if($result_manage_course->num_rows > 0 )
            {   
              while ($row = mysqli_fetch_array($result_manage_course))
              {
                  $program_id = $row[0];
                  $program_code = $row[1];
                  $program_name= $row[2];
          ...
          <!-- start: Content -->
            <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown" style="padding-left:10px;">
                         This section can update the information of the selected program.
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>UPDATE PROGRAM</h3></div>
                     <form id="defaultForm" method="post" action="update_Manage_course_info_process.php">
                      <div class="panel-body" style="padding-bottom:30px;">
                        <input name="program_id" type="hidden" value ="<?php echo $program_id; ?>" />
                          <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-md-3">
                               <h5 style="padding-left:5px;">PROGRAM CODE</h5>
                                <div class="form-group has-feedback">
                                  <input type="text" name="program_code" id="program_code" class="form-control" placeholder="Program code" value ="<?php echo $program_code ; ?>"/>
                                </div>
                            </div>
							<?php
								$comstart1="";
                            ...
                            <div class="col-md-2"></div>
                             <div class="col-md-6">
                                <h5 style="padding-left:5px;">PROGRAM NAME</h5>
                                <div class="form-group has-feedback">
                                  <textarea rows ="4" name="program_desc" id="program_desc" class="form-control" placeholder="program description"> <?php echo $program_name; ?> </textarea>
                                </div>
                            </div>
                            <div class="col-md-4"></div>
                          </div> 
                         <div class="row">
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                  <button type="submit" class="btn btn-info btn-block" name="btn_update_course" id="btn-update_course"><span class="glyphicon glyphicon-floppy-saved"></span> &nbsp;SAVE</button>
                               </div>
                                <div class="col-md-4">
   ...
   $('#defaultForm')
        .bootstrapValidator({
            ...
            stringLength: {
                            min: 3,
                            max: 15,
                            message: 'Program code be more than 3 and less than 15 characters long'
                        },
            regexp: {
                            regexp: /^[a-zA-Z\.]+$/,
                            message: 'Program code can only consist of alphabetical characters,'
                        },
                    }
                },
                program_desc: {
                    validators: {
                        notEmpty: {
                            message: 'Program description is required and can\'t be empty'
                        },
                stringLength: {
                            min: 6,
                            max: 100,
                            message: 'Program description must be more than 6 and less than 100 characters long'
                        },
                        regexp: {
                            regexp: /^[a-zA-Z \.]+$/,
                            message: 'Program description can only consist of alphabetical characters,'
                        },
                    }
                },
            }
