				...
				<div class="col-md-1"></div>
						...
						$message="";
							...
							if(isset($_POST['btn']))
							{
								...
								$query_3="SELECT COUNT(endorsement_id) AS en_count FROM endorsement WHERE stud_no='$stud_no'";
								...
								if(mysqli_num_rows($result_3)>0)
								{
									...
									if($en_count>1)
									{
										$message ="This student applied $en_count companies(Click this label to show records).";
									}
									if($en_count==1)
									{
										$message = "This student applied $en_count company(Click this label to show records).";
									}
								}	
							}
						?>
						  ...
						  <div class="col-md-2"></div>
						   ...
						   <div class="col-md-4">
							...
							<br>
							  ...
							  <div class="row">
                            <div class="col-md-2"></div>
							<div class="col-md-4"><a href="#" style="display:<?php echo $show;?>" data-toggle="modal" data-target="#myModal">
							<?php
							echo $message;
							?> 
							  ...
							  <div class="modal fade" id="myModal" role="dialog">
								<div class="modal-dialog">
								  ...
								  <div class="modal-content">
									...
									<?php
										$query_studList = "
										SELECT b.comp_name,b.city,a.date_created,a.contact_person,a.position,c.lname,c.fname,c.mname,c.title
										FROM endorsement AS a 
										INNER JOIN company_info as b
										INNER JOIN adviser_info as c
										WHERE a.stud_no='$stud_no'
										AND a.comp_id = b.comp_id
										AND a.adviser_id = c.adviser_id";
