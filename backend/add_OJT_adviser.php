...
$year = date('Y');
$adviser_id = 'ADV'.$year.$rnd_ai ;
$q_user = "select username from company_info where username='$adviser_id'";
$q_user_res = $dbc->query($q_user);
while($q_user_res->num_rows > 0){
$rnd_ai = (mt_rand(1000,10000));
$year = date('Y');
$adviser_id = 'ADV'.$year.$rnd_ai ;
$q_user = "select username from company_info where username='$adviser_id'";
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">ADD NEW OJT ADVISER</h1>
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>ADD OJT ADVISER INFORMATION</h3></div>
                     <form id="defaultForm" method="post" action="add_OJT_adviser_process.php">
                      <div class="panel-body" style="padding-bottom:30px;">
                          <input name="adviser_id" type="hidden" value ="<?php echo $adviser_id ?>"/>
                         <div class="row">
                         <div class="col-md-3">
                            <h5 style="padding-left:5px;">ADVISER ID</h5>
                              <h4 style="padding-left:5px;"><?php echo $adviser_id; ?></h4>
                         </div>
                          ...
                          <div class="col-md-2"> 
                           ...
                           <div class="col-md-4">
                             <h5 style="padding-left:5px;">LASTNAME</h5>
                              <div class="form-group has-feedback">
                                <input type="text" name="lname" id="lname" class="form-control" placeholder="lastname" maxlength="32"/>
                               </div>
                            </div>
                          <div class="col-md-3">
                            <h5 style="padding-left:5px;">FIRSTNAME</h5>
                              <div class="form-group has-feedback">
                                <input type="text" name="fname" id="fname" class="form-control" placeholder="firstname" maxlength="32"/>
                               </div>
                          </div>
                          <div class="col-md-3">
                            <h5 style="padding-left:5px;">MIDDLENAME</h5>
                              <div class="form-group has-feedback">
                                  <input type="text" name="mname" id="mname" class="form-control" placeholder="middlename" maxlength="32"/>
                              </div>
                          </div>
                        </div>
                         <div class="row">
                           ...
                           <div class="col-md-3">
                            ...
                            <div class="form-group has-feedback">
                                <?php
                                $query_program_list = "SELECT * FROM program_list WHERE status = 'Active' AND program_id !='21' AND program_id !='20'";
                        ...
                        <br>
                          <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-success btn-block" name="btn_adviser_add" id="btn_adviser_add1"><span class="icons icon-action-redo"></span> &nbsp;SUBMIT</button>
                             </div>
                             <div class="col-md-4">
    ...
    $('#datatables').DataTable();
        ...
        .bootstrapValidator({
            ...
            stringLength: {
                         ...
                         regexp: {
                            regexp: /^[a-zA-Z ]+$/,
                            message: 'The firstname may only consist of letters'
                        }
                    }
                },
         mname: {
                    ...
                    validators: {
                      ...
                      regexp: {
                            regexp: /^[a-zA-Z .]+$/,
                            message: 'The middlename may only consist of letters'
                        }
                    },
              },
              email: {
                ...
                program_id: {
                    message: 'The program is invalid',
                    validators: {
                        notEmpty: {
                ...
                semester: {
                 ...
                 section_id: {
                    message: 'The section is invalid',
                    validators: {
                        notEmpty: {
