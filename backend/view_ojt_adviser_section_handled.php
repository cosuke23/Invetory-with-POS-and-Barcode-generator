...

{
  ...
  if((isset($_GET['acad_year_start'])) && (isset($_GET['semester'])) && (isset($_GET['adviser_id'])) ) {
  ...
  $query_update_OJT_adviser_section_handled ="SELECT a.adviser_id,a.lname,a.fname,a.mname,a.title,a.program_id,b.semester,b.section_id,b.acad_year_start,b.acad_year_end,c.section,d.program_code FROM adviser_info AS a INNER JOIN adviser_section_handled AS b INNER JOIN section_list AS c INNER JOIN program_list AS d WHERE a.adviser_id = b.adviser_id AND a.program_id = d.program_id AND b.section_id = c.section_id AND b.acad_year_start = '$acad_year_start' AND b.adviser_id = '$adviser_id' AND b.semester = '$semester' ";
                  ...
                  <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown" style="padding-left:10px;">
                          ...
                          This section can view the section handled of adviser.
