            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">COMPANY INFORMATION</h1>
                        <p class="animated fadeInDown" style="padding-left:10px;">
                          You can view the list of all partner companies in this module.
                        </p>
                    </div>
                </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>List of all Companies</h3></div>
                      ...
                      <?php
                      $query = "SELECT comp_id,comp_name,comp_desc,address,city,contact_person,position,tel_no,fax_no,email,status,remarks,DATE_FORMAT(date_notary, '%m/%d/%Y') AS date_notary,DATE_FORMAT(date_expiry, '%m/%d/%Y') AS date_expiry FROM company_info";
                          $result_company_info = mysqli_query($dbc, $query);
                          $num_rows = mysqli_num_rows($result_company_info);
            print '<div class="panel-body">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th class="text-center">DATE NOTARY</th>
                          <th class="text-center">DATE EXPIRY</th>                     
                        </tr>
                      </thead>
                      <tbody>';
                        while($row = mysqli_fetch_array($result_company_info)) {
                      ...
                      ?>
                       <tr style="<?php print 'background-color:' . $color . ';'; print 'color:' . $font; ?>">      
                                ...
                                <td><?php echo '<img src="../files/company/'.$comp_id.'.jpg" style="height:50px;width:60px;">';?><?php echo '&nbsp;&nbsp;'.$comp_name; ?></td> 
                               
                                <td style="display:none;"><?php echo $comp_desc; ?></td> 
                                <td style="display:none;"><?php echo $address; ?></td>
                                <td style="display:none;"><?php echo $city; ?></td> 
                                <td style="display:none;"><?php echo $contact_person; ?></td> 
                                <td style="display:none;"><?php echo $position; ?></td> 
                                <td style="display:none;"><?php echo $phone_no; ?></td>
                                <td style="display:none;"><?php echo $fax_no; ?></td>
                                 <td style="display:none;"><?php echo $email; ?></td>
                                <td><?php echo $status; ?></td>
                                <td><?php echo $remarks; ?></td>
                                <td><?php echo $date_notary; ?></td>
