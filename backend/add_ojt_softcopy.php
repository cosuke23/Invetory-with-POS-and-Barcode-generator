            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">ADD NEW OJT SOFTCOPY FILE</h1>
                        <p class="animated fadeInDown" style="padding-left:10px;">
                         This section can add a new OJT Softcopy file.
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>ADD OJT SOFTCOPY FILE</h3></div>
                     <form id="defaultForm" method="post" action="add_ojt_softcopy_process.php" enctype="multipart/form-data">
                      <div class="panel-body" style="padding-bottom:30px;">
                         ...
                         <div class="col-md-3"></div>
                            ...
                            <h4 style="padding-left:5px;">FILE DESCRIPTION:</h4>
                             <div class="form-group has-feedback">
                                <textarea name="file_desc" type="text" class="form-control" maxlength="100"></textarea>
                                </div>
                         </div>
						         </div>
                         ...
                         <br>
                           ...
                           <div class="col-md-4"></div>
                              <div class="col-md-4">
                                <button type="submit" class="btn btn-success btn-block" name="btn-softcopy-add" id="btn-softcopy-add"><span class="glyphicon glyphicon-plus"></span> &nbsp;ADD</button>
                             </div>
                             <div class="col-md-4">
    ...
    $('#datatables').DataTable();
        ...
        .bootstrapValidator({
            ...
            stringLength: {
                         ...
                         regexp: {
                            regexp: /^[a-zA-Z ]+$/,
                            message: 'File Description may only consist of letters'
                        }
                    }
                },
                fileToUpload: {
