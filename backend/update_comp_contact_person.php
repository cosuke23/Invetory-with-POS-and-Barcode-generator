...
if($usertype!=1)
{
  ...
  if(isset($_GET['comp_id']) && isset($_GET['ocp_id']) ) {
  
  $comp_id=$_GET['comp_id'];
  $ocp_id=$_GET['ocp_id'];
  $queryocp_comp_info = "SELECT a.id,a.contact_person,a.position,a.tel_no,a.fax_no,a.email,a.status,a.remarks,DATE_FORMAT(a.date_notary, '%m/%d/%Y') AS date_notary,DATE_FORMAT(a.date_expiry, '%m/%d/%Y') AS date_expiry FROM company_info_other_contact_person as a WHERE id = $ocp_id AND comp_id = $comp_id";
  $result2ocp =  mysqli_query($dbc, $queryocp_comp_info);   
  if($result2ocp->num_rows > 0 )
            {   
				$x = 0;
              while ($row = mysqli_fetch_array($result2ocp))
              {
                $ocp_id = $row[0]; 
         ...
         <!-- start: Content -->
            <div id="content">
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Update Contact Person</h3><h4>for <?php echo $comp_name?></h4></div>
                    <br>
                    <?php
                  ...
                  ?>
                     ...
                     <form id="defaultForm" method="post" action="update_comp_contact_person_process.php" enctype="multipart/form-data">
                       <div class="panel-body" style="padding-bottom:30px;">
                        <input name="comp_id" type="hidden" value ="<?php echo $comp_id ?>"/>
                       
                        <input name="ocp_id" type="hidden" value ="<?php echo $ocp_id ?>"/>
                             ...
                             <div class="col-md-3">
                                  ...
                                  <div class="dateContainer">
                                      <div class="input-group input-append date" id="date_notary">
                                          <input type="text" class="form-control" name="date_notary"  placeholder="(e.g. MM/DD/YYYY)" value="<?php if($date_notary1=="01/01/1970"){ echo "";}else{echo $date_notary1;} ?>"></input>
                             ...
                             <div class="col-md-3">
                                ...
                                <div class="dateContainer">
                                    <div class="input-group input-append date" id="date_expiry">
                                        <input type="text" class="form-control" name="date_expiry" placeholder="(e.g. MM/DD/YYYY)" value ="<?php if($date_expiry1=="01/01/1970"){ echo "";}else {echo $date_expiry1 ;} ?>"/>
                                        <span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
                                    </div>
                                </div>
                            </div>
  ...
  $(document).ready(function(){
    ...
    $('#date_expiry')
        ...
        .bootstrapValidator({
            ...
            regexp: {
                            regexp: /^[0-9]+$/,
                            message: 'Contact Number may only consist of numbers'
                        },
            stringLength: {
                            min: 7,
                            max: 11,
