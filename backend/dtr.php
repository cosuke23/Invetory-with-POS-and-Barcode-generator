   ...
   <div class="container-fluid mimin-wrapper">
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">DAILY TIME RECORD</h1>
                        <p class="animated fadeInDown" style="padding-left:10px;">
                            This section will show the daily time record of the student.
                        </p>
                    </div>
                </div>
              </div>
          ...
          <?php
              ...
              <div class="col-md-12">
                 ...
                 else if(isset($_GET['reject']) && isset($_GET['date_submitted'])) 
                            {   
                              $date_submitted_rej = $_GET['date_submitted'];
                            print '
                             <div class="col-md-12">
                              <div class="alert alert-success alert-dismissible fade in" role="alert">
                                     <span class="fa fa-check-square-o"></span> &nbsp; | &nbsp;
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">×</span></button>
                                    <strong>&nbsp;The DTR and Journal has been deleted from the date of '.$date_submitted_rej.'!</strong>
                               </div></div>';
                            }
              ?>
                      <div class="row" style="padding-top:10px;">
                          <div class="col-md-12">
                            <div class="col-md-4">
                               <h4><span class="fa fa-hourglass-1">&nbsp;PENDING HOURS: 
                               <?php 
                               if($total_pending_hours ==""){
                                echo "None";
                               }else{
                                  echo $F_total_pending;
                               }
                                 ?> 
                               </h4>
                            </div>
                             <div class="col-md-4">
                              <h4><span class="fa fa-hourglass-3">&nbsp;APPROVED HOURS:
                               <?php echo $F_total_approve; ?></h4>
                            </div>
                            <div class="col-md-2">
                               <button type="submit" class="btn btn-danger btn-outline btn-sm btn-block prettyprint"  name ="btn_reject" id="btn_reject">
                          ...
                          <div class="row" style="padding-top:10px;">
                             <div class="col-md-12">
                               <div class="col-md-4">
                                <h4><span class="fa fa-hourglass">&nbsp;TOTAL HOURS: <?php echo $total_hours; ?></h4>
                              </div>
                              <div class="col-md-4">
                                <h4><a href="adviser_approved_dtr_list.php?acad_year_start_rd=<?php echo $acad_year_start_rd; ?>&semester_rd=<?php echo $semester_rd; ?>&stud_no_records=<?php echo $stud_no_records; ?>">
                                  <span class="fa fa-tasks">&nbsp;</span>Approved DTR List</a></h4>
                              </div>
							   <div class="col-md-4">   
                              <button type="submit" class="btn btn-primary btn-outline btn-sm btn-block prettyprint"  name ="btn_checkall" id="btn_checkall">
                                    <span class="fa fa-check-square-o"></span> &nbsp; CHECK ALL &nbsp;
                                </button> 
                              </div>
                            </div>
                      ...
                      <?php
                       $query_dtr ="SELECT a.stud_no,a.category_id,SUM(a.input_minutes) AS input_minutes,DATE_FORMAT(a.date_submitted, '%m/%d/%Y'),a.remarks,a.acad_year_start,a.acad_year_end,a.semester,a.dtr_id,b.ojt_hours,c.comp_name FROM dtr AS a INNER JOIN program_category_list AS b  INNER JOIN (SELECT * from company_info GROUP BY comp_id) AS c WHERE c.comp_id = a.comp_id AND a.category_id = b.category_id AND a.stud_no = '$stud_no_records' AND a.acad_year_start = '$b_acad_year_start' AND a.semester = '$b_semester' AND a.remarks = 'Pending' group by a.dtr_id,a.date_submitted";
                          ...
                          <?php
                            if($remarks == 'Approved')
                              print '<td>
                                ...
                                print '<td>
                                  <div class="form-group form-animate-checkbox">
                                   <input id="checkbox" name="checkbox[]" class="checkbox" type="checkbox" value='.$dtr_id.'>
                                  </div> 
                                </td>  ';
                              }
                            ?>    
...
<script type="text/javascript">
 ...
 var buttons = new $.fn.dataTable.Buttons(table, {
  ...
  $('#btn_checkall').click(function() {
		...
		var CHECKALL = ' <span class="fa fa-check-square-o"></span> &nbsp; CHECK ALL &nbsp;';
		var UNCHECKALL = ' <span class="fa fa-square-o"></span> &nbsp; UNCHECK ALL &nbsp;';
		$email_box=$('.checkbox',nodes);
		if($email_box.prop("checked")==true){
                $email_box.prop("checked", false);
				$('#btn_checkall').html(CHECKALL);
        }
               else{
                 $email_box.prop("checked", true);
				 $('#btn_checkall').html(UNCHECKALL);
		 }
    });
