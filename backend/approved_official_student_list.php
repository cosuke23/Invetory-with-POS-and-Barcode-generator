            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">OFFICIAL STUDENTS LIST</h1>
                        <p class="animated fadeInDown" style="padding-left:10px;">
                          	Manage official students in this section.
                        </p>
                    </div>
                </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>List of all Approved Students</h3></div>
                    <br>
                      <?php
...
<script type="text/javascript">
  $(document).ready(function(){
   var table = $('#datatables').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "approved_official_student_list_processing.php",
