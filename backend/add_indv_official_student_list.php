              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <form action="add_indi_official_student_list_process.php" method="post" id="defaultForm">
                    <div class="row">
                      <div class="col-md-12">
                      <div class="col-md-4">
                      <h5>STUDENT NUMBER</h5>
                        <div class="form-group has-feedback">
                          <input type="text" class="form-control" name="stud_no_indv" id="stud_no_indv" placeholder="Student Number" maxlength="11">
                        </div>
                      </div>
                      <div class="col-md-3">
                  ...
                  if($program_code==$program_code2)
                  {
                    $comstart3="<!--";
                                ...
                                if($counter <= $program_id2)
                                  {
                                      echo $comstart3."<option value='".$program_code2."'>".$program_code2."</option>".$comend2;
                                     $counter++;
                                  }   
                                }
                                ?>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                 <button type="submit" class="btn btn-info btn-block"  name="btn_add_stud_indv" id="btn_add_stud_indv">
