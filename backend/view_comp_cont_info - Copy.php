            ...
            <div id="content">
              ...
              <div class="panel box-shadow-none content-header">
               ...
               <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>LIST OF COMPANY PROGRAMS</h3></div>
                      <div class="panel-body" style="padding-bottom:30px;">
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>LIST OF ALL OJT OFFERS OF COMPANY <label style="color:black;"><?php echo $comp_name; ?></label></h3></div>
                      <div class="panel-body" style="padding-bottom:30px;">
                        <div class="row" style="padding-left:5px;">
                             <div class="col-md-8">
                             </div> 
