            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">REMOVE STUDENT</h1>
                ...
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading">
                     <div class="row">
                      <div class="col-md-9">
                          <h3>Are you sure that you want to remove <b><?php echo 'Student no: '.$stud_no.'. <br> '. $stud_name ?></b> from your student list?</h3>
                      </div>
					  ...
					  <br>
					  <a href="adviser_section_handled.php" class="btn btn-default"><i class="fa fa-back"></i>&nbsp;Cancel&nbsp;</a>
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					  <a href="remove_student_process.php?stud_no=<?php echo $stud_no; ?>&stud_name=<?php echo $stud_name ?>" class="btn btn-danger"><i class="fa fa-trash"></i>&nbsp;Remove&nbsp;</a>
                    </div>
