           ...
           <!-- start: Content -->
            <div id="content">
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>UPDATE ADMIN INFORMATION</h3></div>
                    <form id="defaultForm" method="post" action="update_admin_info_process.php" enctype="multipart/form-data">
