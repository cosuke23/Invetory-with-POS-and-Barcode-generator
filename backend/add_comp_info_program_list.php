...
if(isset($_GET['comp_id'])) {
  ...
  $query_comp_info = "SELECT comp_id,comp_name FROM company_info WHERE comp_id = $comp_id";
         ...
         <!-- start: Content -->
            <div id="content">
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>ADD COMPANY PROGRAM</h3></div>
                     <br>
                    <?php
                            ...
                            ?>
                     <form id="defaultForm" method="post" action="add_comp_info_program_list_process.php">
                         ...
                         <div class="col-md-3">
                           ...
                           <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <h4>Active</h4>
                                  <input type="hidden" name="comp_program_status" value="Active"/>
                           </div>
                        </div>
                        <br>
                        <br>
                          <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-success btn-block" name="btn_add_comp_info_program_program_list" id="btn_add_comp_info_program_program_list"><span class="glyphicon glyphicon-plus"></span> &nbsp;ADD</button>
                             </div>
                            <div class="col-md-4">
  ...
  $(document).ready(function(){
        ...
        .bootstrapValidator({
            ...
            fields: {
                ...
                comp_program_status: {
                    message: 'Company program status is not valid',
                    validators: {
                        notEmpty: {
                            message: 'Company program status is required and can\'t be empty'
                        },
                    }
                },
            }
