...
if(isset($_GET['comp_id']) &&  isset($_GET['ojt_offers_id'])) {
  
  $comp_id= $_GET['comp_id'];
   $ojt_offers_id= $_GET['ojt_offers_id'];
  $query_comp_info = "SELECT a.comp_id,a.comp_name,a.status,b.ojt_offers_id,b.ojt_title,b.ojt_desc,b.status,b.program_id,c.program_code FROM company_info AS a INNER JOIN ojt_offers AS b INNER JOIN program_list AS c WHERE a.comp_id = b.comp_id AND b.program_id = c.program_id AND b.ojt_offers_id = '$ojt_offers_id' AND a.comp_id = '$comp_id'";
         ...
         <!-- start: Content -->
            <div id="content">
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>UPDATE OJT OFFERS</h3></div>
                     <form id="defaultForm" method="post" action="update_ojt_offers_process.php">
                      <div class="panel-body" style="padding-bottom:30px;">
                          <input name="comp_id" type="hidden" value ="<?php echo $comp_id ?>"/>
                          <input name="program_id_oo" type="hidden" value ="<?php echo $program_id_oo; ?>"/>
                          <input name="ojt_offers_id" type="hidden" value ="<?php echo $ojt_offers_id; ?>"/>
                         <div class="row">  
                           <div class="col-md-6">
                               <h5>COMPANY NAME</h5>
                           ...
                           <div class="col-md-3">
                               <h5 >COMPANY STATUS</h5>
                                  <div class="form-group">
                                    <h4><?php echo $comp_status; ?></h4>
                                  </div>
                           </div>
                           <div class="col-md-3">
                                <h5 style="padding-left:5px;">OFFER STATUS</h5>
                                  <div class="form-group has-feedback">
                                       <?php
										...
										if($offer_status=="Available")
										{
											$comstart1="<!--";
										}
										else if($offer_status=="Not Available")
										{
											$comstart2="<!--";
										}
									   ?>
									   <select class="form-control" name="offer_status" id="offer_status" class="form-control" placeholder="Status">
                                        <option><?php echo $offer_status; ?></option>
                                        <?php echo $comstart1;?><option value="Available">Available</option><?php echo $comend;?>
                                        <?php echo $comstart2;?><option value="Not Available">Not Available</option><?php echo $comend;?>
                                        </select>
                                  </div>
                           </div>
                         </div>
                           <div class="row">
                            <div class="col-md-9">
                            <h5 style="padding-left:5px;">OJT TITLE</h5>
                                <div class="form-group has-feedback">
                                  <textarea rows ="2" name="ojt_title" id="ojt_title" class="form-control" placeholder="ojt title" maxlength="100"> <?php echo $ojt_title; ?> </textarea>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="form-group has-feedback">
                                <?php
                                $query_program_list = "SELECT a.comp_id,a.program_id,b.program_code FROM company_program AS a INNER JOIN program_list AS b WHERE a.program_id = b.program_id  AND a.comp_program_status = 'Active' AND a.comp_id = '$comp_id' AND status = 'Active'";
                                ...
                                print'<select class="form-control"  name="program_id" class="form-control"> ';
                                 ...
                                 echo "<option value='".$program_id_oo."'>".$program_code."</option>";
                                 while($row_pl = mysqli_fetch_array($result_program_list)){
                                    $comp_id = $row_pl[0];
                                    $program_id2 = $row_pl[1];
                                    $program_code2 = $row_pl[2]; 
                  ...
                  if($counter <= $program_id)
                    {
                      echo $comstart3."<option value='".$program_id2."'>".$program_code2."</option>".$comend1;
                     $counter++;
                    }   
                                }
                                ?>
                            ...
                            <div class="row">
                            <div class="col-md-12">
                                <h5 style="padding-left:5px;">OJT DESCRIPTION</h5>
                                <div class="form-group has-feedback">
                                  <textarea rows ="5" name="ojt_desc" id="ojt_desc" class="form-control" placeholder="ojt description" > <?php echo $ojt_desc; ?> </textarea>
                                </div>
                            </div>
                            </div>
                        <br>
                          <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-info btn-block" name="btn_ojt_offers" id="btn_ojt_offers"><span class="glyphicon glyphicon-floppy-saved"></span> &nbsp;SAVE</button>
                             </div>
                            <div class="col-md-4">
                               <a href="ojt_offers_masterlist.php"><button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-chevron-left"> &nbsp;BACK</span></button></a>
                            </div>
  ...
  $(document).ready(function(){
        ...
        .bootstrapValidator({
            ...
            fields: {
                ...
                offer_status: {
                    message: 'OJT offer status is not valid',
                    validators: {
                        notEmpty: {
                            message: 'OJT offer status required and can\'t be empty'
                        },
                    }
                },
                ojt_title: {
                    validators: {
                        ...
                        stringLength: {
                            min: 5,
                            max: 100,
                            message: 'OJT title must be more than 5 and less than 100 characters long'
                        },
                         regexp: {
                            regexp: /^[a-zA-Z \-=.!@#$%^&*()_+{}|<>:,/? 0-9]+$/,
                 ...
                 ojt_desc: {
                    validators: {
                        notEmpty: {
                            message: 'OJT description is required and can\'t be empty'
                        },
                        stringLength: {
                            min: 5,
                            max: 2500,
                            message: 'OJT description be more than 5 and less than 2500 characters long'
                        },
                         regexp: {
                            regexp: /^[a-zA-Z \-=.!@#$%^&*()_+{}|<>:,`/? 0-9]+$/,
                            message: 'Invalid characters'
