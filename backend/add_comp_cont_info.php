          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>ADD NEW PARTNER COMPANY</h3></div>
                      <form id="defaultForm" method="post" action="add_comp_cont_info_process.php"  enctype="multipart/form-data">
                      ...
                      <div class="panel-body" style="padding-bottom:30px;">
                        ...
                        <div class="col-md-4">
                            <h5 style="padding-left:5px;">COMPANY USERNAME</h5>
								<?php		  //generate comp user name and password
									$rnd_ai = (mt_rand(1000,10000));
									$year = date('Y');
									$cmp_user = 'CMP'.$year.$rnd_ai ;
									$q_compuser = "select username from company_info where username='$cmp_user'";
									$q_compuser_res = $dbc->query($q_compuser);
									while($q_compuser_res->num_rows > 0){
										$rnd_ai = (mt_rand(1000,10000));
										$year = date('Y');
										$cmp_user = 'CMP'.$year.$rnd_ai ;
										$q_compuser = "select username from company_info where username='$cmp_user'";
									...
									?>
                              <h4 style="padding-left:5px;"><?php echo $cmp_user; ?></h4>
							   <input name="cmp_user" type="hidden" value ="<?php echo $cmp_user ?>"/>
                        </div>
                          <div class="col-md-8">
                            <h5 style="padding-left:5px;">COMPANY PICTURE &nbsp; <i class="fa fa-camera"></i> </h5>
                               <div class="form-group has-feedback">
                               <input type="file" name="image" class="form-control"  placeholder="Upload Image(Optional)"/> 
                               </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-8">
                                ...
                                <div class="form-group has-feedback"> 
                                  <input type="text" name="comp_name" list="suggestion" id="comp_name" class="form-control" placeholder="Company Name"/>
								  <input type="hidden" name="btn2"/>
								  <?php
								  $q_suggestion = "SELECT * FROM company_info WHERE status = 'Active'";
                            ...
                            <div class="form-group has-feedback">
                                ...
                                print'<select class="form-control"  name="program_id" class="form-control"> ';
                                 ...
                                 echo "<option value='".$program_id_ai."'>".$program_code."</option>";
                          ...
                          <div class="form-group has-feedback">
                              <textarea rows ="2" name="comp_desc" id="comp_desc" class="form-control" placeholder="(Optional) Company Description"></textarea>
                          </div>
                          <div class="row">
                            <div class="col-md-8">
                                 <h5 style="padding-left:5px;">ADDRESS</h5>
                                <div class="form-group has-feedback">
                                  <textarea rows ="2" name="address" id="address" class="form-control" placeholder="Company Address"></textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group has-feedback">
                                  <input type="text" name="tel_no" id="tel_no" class="form-control" placeholder="Contact Number"  maxlength="11"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h5 style="padding-left:5px;">FAX NUMBER</h5>
                                <div class="form-group has-feedback">
                                  <input type="text" name="fax_no" id="fax_no" class="form-control" placeholder="(Optional)Fax Number" maxlength="12"/>
                                </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-12">
                                <div class="panel-body">
                                  <div class="well well-sm">
                                      ...
                                      <p> &nbsp;  &nbsp;  &nbsp; You can add <strong><mark class="text-primary">programs</mark></strong> and <strong><mark class="text-primary">OJT offers</mark></strong> by going to Partner Companies. Click "Program" to add a new program, or "Add OJT Offer" to add a new OJT offer.</p>
                                      <p> &nbsp;  &nbsp;  &nbsp; The default password of the company for logging in into the system is the company <strong><mark class="text-primary">username</mark></strong>. They can change it by logging their account into the system.</p>
                                   </div>
                                </div>  
                          </div>
                        </div>
                ...
                comp_name: {
                    ...
                    validators: {
                        ...
                        stringLength: {
                            min: 5,
                            max: 255,
                            message: 'Company name must be more than 5 and less than 255 characters long'
                        },
                         regexp: {
                            regexp: /^[a-zA-Z \-=.!@#$%^&*()_+{}|<>:,`/? 0-9]+$/,
                ...
                comp_desc: {
                    validators: {
                        stringLength: {
                            min: 1,
                            max: 1000,
                            message: 'Company description must be more than 5 and less than 1000 characters long'
                        },
                         regexp: {
                            regexp: /^[a-zA-Z \-=.!@#$%^&*()_+{}|<>:,/? 0-9]+$/,
                            message: 'Invalid characters'
            ...
            position: {
                   ...
                   regexp: {
                    ...
                    stringLength: {
                            min: 2,
                            max: 50,
                            message: 'Position must be more than 5=2 and less than 50 characters long'
                        },
                    }
                },
            contact_person: {
