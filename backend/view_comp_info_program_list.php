...
if(isset($_GET['comp_id']) && isset($_GET['program_id']) ) {
  ...
  $query_comp_info = "SELECT a.comp_id,a.comp_name,b.program_id,c.program_code,b.comp_program_status FROM company_info AS a INNER JOIN company_program AS b INNER JOIN  program_list AS c WHERE a.comp_id = b.comp_id AND b.program_id = c.program_id AND b.program_id  = '$program_id' AND a.comp_id = '$comp_id'";
                  ...
                  <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown" style="padding-left:10px;">
                         ...
                         This section can view the program list of the company.
              ...
              <div class="col-md-12 padding-0">
                ...
                <div class="col-md-12">
                  ...
                  <div class="panel">
                    ...
                    <div class="panel-heading"><h3>VIEW COMPANY PROGRAM</h3></div>
                            ...
                            <h5 style="padding-left:5px;">PROGRAM</h5>
                             ...
                             <div class="col-md-3">
                                ...
                                <h5 style="padding-left:5px;">COMPANY PROGRAM STATUS</h5>
                                  ...
                                  <h4><?php echo $comp_program_status; ?></h4>
