          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
              ...
              <!------------------------------------------------COMPANY INFORMATION------------------------------------------------------>
				...
				if(isset($_GET['comp_nameX']))
								{
									$comp_name=$_GET['comp_nameX'];
								}
				
					if(isset($_GET['comp_id2']))
								{
									$comp_id2=$_GET['comp_id2'];
								}
								
								if(isset($_GET['checkersx']))
								{
									$checkersx=$_GET['checkersx'];
								}
					   ...
					   <input type="hidden" name="sub_date" value="<?php echo $sub_date;?>"/></div>
						   <div class="col-md-4">
                                ...
                                <div class="form-group has-feedback"> 
                                  <input type="text" name="comp_name" list="suggestion" id="comp_name" class="form-control" value="<?php 
								  if(isset($_GET['comp_nameX']))
								  {
									  echo $_GET['comp_nameX'];
								  }
								  if(isset($_GET['comp_name']))
								{
									$comp_name=$_GET['comp_name'];
								}
								  if(isset($_POST['comp_name'])){$comp_show=$_POST['comp_name'];echo $comp_show;}?>" placeholder="Company Name"/>
								...
								if(isset($_GET['comp_city']))
								{
									$comp_city=$_GET['comp_city'];
								}else
								{
								$comp_city="";
								}
								...
								if(isset($_GET['en_count']))
								{
									$en_count=$_GET['en_count'];
								}else
								{
								$en_count='0';
								}
								...
								if(isset($_POST['btn2']) && isset($_GET['stud_no']))
								{
									...
									$query_2="SELECT comp_id,comp_name,address,fax_no,city,contact_person,position,tel_no,email,status,remarks,DATE_FORMAT(date_notary, '%M %d, %Y') as date_notary,DATE_FORMAT(date_expiry, '%M %d, %Y') as date_expiry FROM company_info WHERE comp_id='$comp_id2'";
									...
									if(mysqli_num_rows($result_2)>0)
									{
										...
										$status = $r2['status'];
										$remarks = $r2['remarks'];
										$date_notary = $r2['date_notary'];
										$date_expiry = $r2['date_expiry'];					
									}
									$query_3="SELECT COUNT(A.endorsement_id) AS en_count FROM endorsement as A JOIN student_ojt_records AS B WHERE A.stud_no = B.stud_no AND A.comp_id='$comp_id2' and A.status='Active' AND B.ojt_status = 'Ongoing'";
									...
									$query_4x="SELECT COUNT(id) AS total FROM company_info_other_contact_person WHERE comp_id='$comp_id2' AND status = 'Active'";
									...
									if(mysqli_num_rows($result_4x)>0)
									{
										...
										if($checkersx>0)
										{
											...
											$_POST['contact_person'] = $contact_p;
                        ...
                        <div class="panel-body">
						   ...
						   <?php
						   	if(isset($_POST['btn3']) && isset($_GET['stud_no']) && isset($_POST['contact_person']))
									{
									$comp_id = $_GET['comp_id'];
									$comp_id2 = $_GET['comp_id2'];
									$stud_no = $_GET['stud_no'];
									...
									$date_created = $_GET['date_created'];
									$sub_date = $_GET['sub_date'];
									//$contact_p=mysqli_real_escape_string($dbc, trim($_POST['contact_person-hidden']));
									$contact_p = $_POST['contact_person'];
									$query_3jm="SELECT COUNT(id) AS CounTa FROM company_info_other_contact_person WHERE comp_id='$comp_id' AND contact_person='$contact_p'";
									$result_3jm=mysqli_query($dbc, $query_3jm);
									if(mysqli_num_rows($result_3jm)>0)
									{
										$r3jm = mysqli_fetch_assoc($result_3jm);
										$en_countjm = $r3jm['CounTa'];
										if($en_countjm>0)
										{
											$query_x2x="SELECT comp_id,contact_person,position,tel_no,fax_no,email,status,remarks,DATE_FORMAT(date_notary, '%M %d, %Y') as date_notary,DATE_FORMAT(date_expiry, '%M %d, %Y') as date_expiry FROM company_info_other_contact_person WHERE contact_person='$contact_p' AND comp_id='$comp_id2'";
											$result_x2x=mysqli_query($dbc, $query_x2x);
											if(mysqli_num_rows($result_x2x)>0)
											{
												$rx2x = mysqli_fetch_assoc($result_x2x);
												$comp_id = $rx2x['comp_id'];
												$contact_p = $rx2x['contact_person'];
												$position = $rx2x['position'];
												$tel_no = $rx2x['tel_no'];
												$fax_no = $rx2x['fax_no'];
												$email = $rx2x['email'];
												$status = $rx2x['status'];
												$remarks = $rx2x['remarks'];
												$date_notary = $rx2x['date_notary'];
												$date_expiry = $rx2x['date_expiry'];
										...
										{
											$query_x2x="SELECT comp_id,contact_person,position,tel_no,fax_no,email,status,remarks,DATE_FORMAT(date_notary, '%M %d, %Y') as date_notary,DATE_FORMAT(date_expiry, '%M %d, %Y') as date_expiry FROM company_info WHERE contact_person='$contact_p' AND comp_id='$comp_id2'";
											$result_x2x=mysqli_query($dbc, $query_x2x);
											if(mysqli_num_rows($result_x2x)>0)
											{
												$rx2x = mysqli_fetch_assoc($result_x2x);
				...
				<!----------------------------------------------FORM 2--------------------------------------------------->
						<script>
						function stata(action)
						{
							document.getElementById("contact_person-hidden").value = action;
						  ...
						  <form id="form2" name="form2" method="POST" enctype="multipart/form-data" action="<?php
						 
						 // $old = $contact_p;
							if(isset($_POST['contact_person']))	
							{
										print "endorsement_process.php";
							}
							else
							{
								
								echo "endorsement2.php?stud_no=".$stud_no."&adviser_id=".$adviser_id."&program_id=".$program_id."&thours=".$thours."&date_created=".$date_created."&sub_date=".$sub_date."&comp_address=".$comp_address."&comp_id=".$comp_id."&comp_id2=".$comp_id."&comp_nameX=".$comp_name."&comp_city=".$comp_city."&en_count=".$en_count."&show=".$show."&checkersx=".$checkersx."&unhide=YES&contact_p=".$contact_p."";
						  ...
						  <!--<form id="form2" action="endorsement_process.php" enctype="multipart/form-data" method="POST">-->
								...
								<input name="hiddendata" type="hidden" value ="0"/>
						   <div class="row">
					...
					<div class="col-md-2"></div>
						  ...
						  <div class="col-md-2"></div>
							 ...
							 <h5 style="padding-left:5px;">Name of Host Company Representative:</h5>
                                <div class="form-group has-feedback"> 
								  ...
								  if(isset($_POST['contact_person']))
									...
									?>" placeholder="Contact Person" onKeyPress="stata('')"/>
									<input type="hidden" name="btn3"/>
								  ...
								  if($checkersx>0)
								  {
								$q_suggestion = "SELECT contact_person,position,tel_no,email,status,remarks,date_notary,date_expiry FROM company_info_other_contact_person WHERE comp_id ='$comp_id2' AND status = 'Active' UNION ALL SELECT contact_person,position,tel_no,email,status,remarks,date_notary,date_expiry FROM company_info WHERE comp_id ='$comp_id2'";
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="form-group has-feedback"> 
                                <input type="text" name="position" id="position" class="form-control" value="<?php 
								  if($position!="")
								  {
									echo $position;
								  }
						  ...
						  <div class="row">
                            ...
                            <div class="col-md-4">
                              <h5 style="padding-left:5px;">Remarks:</h5>
                                <div class="form-group has-feedback">
                                  <input type="text" name="remarks" id="remarks" class="form-control" value="<?php 
								  if($remarks!="")
								  {
									echo $remarks;
								  }
							...
							<div class="col-md-4">
                                ...
                                <div class="dateContainer">
                                    <div class="input-group input-append date" id="date_notary">
                                        <input type="text" class="form-control" name="date_notary" placeholder="(e.g. MM/DD/YYYY)" value="<?php 
								  if($date_notary!="")
								  {
									echo $date_notary;
								  }
                              ...
                              <h5 style="padding-left:5px;">DATE EXPIRY</h5>
                                ...
                                <div class="dateContainer">
                                    <div class="input-group input-append date" id="date_expiry">
                                        <input type="text" class="form-control" name="date_expiry" placeholder="(e.g. MM/DD/YYYY)" value="<?php 
								  if($date_expiry!="")
								  {
									echo $date_expiry;
								  }
        ...
        .bootstrapValidator({
            ...
            fields: {
                comp_name : {
					validators : {
						 notEmpty: {
                            message: 'Company is required and can\'t be empty'
                        }
					}
				}
				}
