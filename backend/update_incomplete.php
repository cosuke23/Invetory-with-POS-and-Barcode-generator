          ...
          <!-- end: Left Menu -->
			<?php
					if(isset($_GET['stud_no']))
					{
						...
						$query_sinfo = "SELECT a.lname, a.fname, a.mname, b.category_description, c.ojt_status, d.comp_name, f.program_code FROM student_info AS a INNER JOIN program_category_list AS b INNER JOIN student_ojt_records AS c INNER JOIN company_info AS d INNER JOIN company_ojt_student AS e INNER JOIN program_list AS f WHERE a.stud_no='$stud_no' AND b.category_id='$category_id' AND c.stud_no='$stud_no' AND c.acad_year_start='$acad_year_start' AND c.acad_year_end='$acad_year_end' AND c.semester='$semester' AND e.stud_no='$stud_no' AND e.comp_id = d.comp_id AND f.program_id=a.program_id";
						
						$result_sinfo = mysqli_query($dbc, $query_sinfo);
						
						if(mysqli_num_rows($result_sinfo)>0)
						{
							$row_sinfo = mysqli_fetch_assoc($result_sinfo);
							$lname = $row_sinfo['lname'];
							$fname = $row_sinfo['fname'];
							$mname = $row_sinfo['mname'];
							$category_description = $row_sinfo['category_description'];
							$ojt_status = $row_sinfo['ojt_status'];
							$comp_name = $row_sinfo['comp_name'];
							$program_code = $row_sinfo['program_code'];
						}
					}
			?>
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">UPDATE OJT STATUS</h1>
                        <p class="animated fadeInDown" style="padding-left:10px;">
                         This section can update the ojt status.
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3><?php echo $lname.", ".$fname." ".$mname;?></h3></div>
                     <form id="defaultForm" method="post" action="update_incomplete_process.php">
                      <div class="panel-body" style="padding-bottom:30px;">
						   ...
						   <div class="col-md-3">
                                <h5 style="padding-left:5px;">OJT STATUS</h5>
                                  <div class="form-group has-feedback">
									   ...
									   <select class="form-control" name="ojt_status" id="ojt_status" class="form-control" placeholder="Status">
                                        <option><?php echo $ojt_status; ?></option>
                                        <?php echo $comstart1;?><option value="Incomplete">Incomplete</option><?php echo $comend;?>
                        ...
                        <br>
                          <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-info btn-block" name="btn_inc" id="btn_inc"><span class="glyphicon glyphicon-floppy-saved"></span> &nbsp;SAVE</button>
                             </div>
                            <div class="col-md-4">
                               <a href="student_master_list.php"><button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-chevron-left"> &nbsp;BACK</span></button></a>
                            </div>
                 ...
                 ojt_desc: {
                    validators: {
                        ...
                        stringLength: {
                            min: 5,
                            max: 200,
                            message: 'OJT description be more than 5 and less than 200 characters long'
                        },
                         regexp: {
                            regexp: /^[a-zA-Z \-=.!@#$%^&*()_+{}|<>:,/? 0-9]+$/,
                            message: 'Invalid characters'
