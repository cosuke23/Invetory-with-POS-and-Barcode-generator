          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown" style="padding-left:10px;">
                           This section will show the list of all student OJT records.
                        </p>
                    </div>
                </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>List of all Student OJT Records</h3></div>
                      <br>
					  <?php
						  if(isset($_GET['sn'])) 
                            {
								...
								<div class="col-md-12">
								  <div class="alert alert-success alert-dismissible fade in" role="alert">
										...
										<strong>&nbsp;'.$sn.' Updated sucessfully!</strong>
								   </div></div>';
                            }
							?>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    var table = $('#datatables').DataTable({
       "processing": true,
        "serverSide": true,
        "ajax": "student_master_list_processing.php",
