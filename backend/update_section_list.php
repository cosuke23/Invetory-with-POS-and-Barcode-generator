...
if($usertype!=1)
{
  ...
  $query_section_list_2 = "SELECT a.section_id, a.section,a.status,b.program_id,b.program_code FROM section_list AS a INNER JOIN program_list AS b WHERE a.program_id = b.program_id and a.section_id ='$section_id' ";
                 
  $result_section_list_2 =  mysqli_query($dbc, $query_section_list_2);          
          if($result_section_list_2->num_rows > 0 )
            {   
              while ($row = mysqli_fetch_array($result_section_list_2))
              {
                  $section_id = $row[0];
                  $section = $row[1];
                  $status = $row[2];
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown" style="padding-left:10px;">
                         This section can manage the program  of OJT student.
                        </p>
                    </div>
                  </div>
              </div>
                ...
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>UPDATE SECTION</h3></div>
                     <form id="defaultForm" method="post" action="update_section_list_process.php">
                      <div class="panel-body" style="padding-bottom:30px;">
                        ...
                        <input name="program_id" type="hidden" value ="<?php echo $program_id; ?>" />
                            ...
                            <div class="col-md-2">
                             ...
                             <div class="col-md-3">
                                <div class="form-group has-feedback">
                                  <input type="text" name="section" id="section" class="form-control" placeholder="section" value="<?php echo $section ; ?>"  maxlength="15"/>
                                </div>
                              </div>
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-4">
                                  <button type="submit" class="btn btn-info btn-block" name="btn_update_section" id="btn_update_section"><span class="glyphicon glyphicon-floppy-saved"></span> &nbsp;SAVE</button>
                            </div>
                            <div class="col-md-4">
                                 <a href="manage_section_list.php?program_id=<?php echo $program_id; ?>"><button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-chevron-left"> &nbsp;BACK</span></button></a>
                            </div>
                          </div>
                          <br>
 ...
 $('#datatables').DataTable();
   $('#defaultForm')
        .bootstrapValidator({
            ...
            fields: {
               section: {
                    message: 'The section code is not valid',
                    validators: {
                        notEmpty: {
            ...
            stringLength: {
                            min: 6,
                            max: 6,
                            message: 'Section code must be 6 characters long'
                        },
            regexp: {
                            regexp: /^[a-zA-Z-0-9]+$/,
                            message: 'Section code can only consist of alphabetical and numeric characters,'
                        },
                    }
                }   
            }
