                ...
                <div class="col-md-12 padding-0">
                  <div class="panel">
                   <div class="row">
					...
					<form id="defaultForm" method="post" action="student_update_ojt_records_process.php?rb=1" enctype="multipart/form-data">
						...
						<br>
                           ...
                           <div class="col-md-3">
							...
							?>
							<div class="col-md-3">
                              <h5 style="padding-left:5px;"><span style="font-size:20px;"><b>SEMESTER / AY</b>&nbsp;</span><label style="color:red;font-size:20px;">*</label><br><span style="color:red;font-size:17px;"><b>NOTE:</b></span> Make sure you select your correct semester.</h5>
                              <div class="form-group has-feedback">
