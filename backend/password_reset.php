...
<?php
	...
	$q_linkcheck ="select * from forget_password_handler where encrypted_code='$encrypted_code' and user_id='$stud_id'";
	...
	if($linkcheck['link_expiry'] > $cur_time){
		print '<div style="padding-top:50px;">
              ...
              <div class="col-md-12 padding-0">
                  ...
                  <div class="panel">
					...
					<form action="password_reset_process.php?stud_id='.$linkcheck['user_id'].'" method="POST">
		...
		echo 'Your link has expired. Please Request Another Password Reset';
