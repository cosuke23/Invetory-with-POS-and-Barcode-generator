             ...
             <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">ONGOING SEMESTERS</h1>
                        <p class="animated fadeInDown" style="padding-left:10px;">
                          View and manage Ongoing Semesters in this module.
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>List of all Ongoing Semesters</h3></div>
                   <br>
                    <div class="row">
                      <div class="col-md-12">

                         <?php
                         if(isset($_GET['sem_update'])) 
                            {   
                            print '<div class="col-md-12">
                              <div class="alert alert-success alert-dismissible fade in" role="alert">
                                    ...
                                    <strong>&nbsp;Semester has successfully been updated.</strong>
                               </div></div>';
                            }
              ...
              <?php
                     $query_sem = "SELECT * from active_semester_acad_year";
                     $result_sem = $dbc->query($query_sem);
                    
            print '<div class="panel-body">
                      <div class="responsive-table">
                      <table  class="table table-bordered table-hover table-condensed table-reflow" width="100%" cellspacing="0">
                      <thead>
                        <tr>
                            <th class="col-md-1">SEMESTER</th>
                          <th class="text-center">ACADEMIC YEAR START</th>
                            <th class="text-center">ACADEMIC YEAR END</th>   
                      ...
                      <tbody>';
                        while($row = $result_sem->fetch_assoc()) {
						   ...
						   $acad_yr_start = $row['active_acad_year_start'];
						   $acad_yr_end = $row['active_acad_year_end'];
						   $status = $row['status'];
                      ?>
                      ...
                      <?php
                        ...
                        ?>      
                                <td><?php echo $sem;?></td> 
                              <td><?php echo $acad_yr_start; ?></td>
                              <td><?php echo $acad_yr_end; ?></a></td>    
                              <td><b><?php echo  $status; ?></b></td>
                              <td class="text-center"><a href="update_active_ongoing_sem.php?sem=<?php echo $sem;?>&acad_yr_start=<?php echo $acad_yr_start; ?>&acad_yr_end=<?php echo $acad_yr_end; ?>&status=<?php echo  $status; ?>" class="btn btn-primary center"><i class="fa fa-pencil"></i>&nbsp; Update</a></td>
                              <!--<td>
