...
if($usertype!=1)
{
  ...
  $query_update_program_category_list = "SELECT a.program_id,a.category_id,a.category_description,a.ojt_hours,b.program_code FROM program_category_list AS a INNER JOIN program_list AS b WHERE a.program_id = b.program_id AND a.category_id = '$category_id' ";
          ...
          <!-- start: Content -->
            <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown" style="padding-left:10px;">
                          This section can add a new ojt category.
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>ADD OJT CATEGORY LIST</h3></div>
                     <form id="defaultForm" method="post" action="add_program_category_list_process.php">
                      <div class="panel-body" style="padding-bottom:30px;">
                        <div class="row">
                         ...
                         <div class="row">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-3">
                             ...
                             <div class="col-md-4">
                                <div class="form-group has-feedback">
                                  <input type="text" name="category_description" id="category_description" class="form-control" placeholder="Category Description" maxlength="100"/>
                                </div>
                              </div>
                          ...
                          <br>
                           <div class="row">
                            ...
                            <div class="col-md-3">
                             ...
                             <div class="col-md-4">
                                <div class="form-group has-feedback">
                                  <input type="text" name="ojt_hours" id="ojt_hours" class="form-control" placeholder="OJT Hours" maxlength="4"/>
                                </div>
                              </div>
                               <div class="col-md-4"></div>
                          </div>
                         ...
                         <div class="row">
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                  <button type="submit" class="btn btn-info btn-block" name="btn_add_program_category_list" id="btn_add_program_category_list"><span class="glyphicon glyphicon-floppy-saved"></span> &nbsp;SAVE</button>
                            </div>
                            <div class="col-md-4">
                                 <a href="program_category_list.php"p><button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-chevron-left"> &nbsp;BACK</span></button></a>
                            </div>
                          </div>
                          <br>
 ...
 $('#datatables').DataTable();
   $('#defaultForm')
        .bootstrapValidator({
            ...
            regexp: {
                            regexp: /^[0-9]+$/,
                            message: 'OJT hours may only consist of numbers'
                        },
            stringLength: {
                            min: 3,
                            max: 4,
                            message: 'OJT hours must be more than 3 and less than 4 numbers'
                        },
                    }
                },
               category_description: {
                    message: 'OJT description is invalid',
                    validators: {
                        notEmpty: {
                ...
                stringLength: {
                            min: 5,
                            max: 80,
                            message: 'OJT hours must be more than 5 and less than 80 alphanumeric characters'
                        },
                regexp: {
                            regexp: /^[a-zA-Z 0-9 -:]+$/,
                            message: 'Invalid characters. OJT description may only consist of alphanumeric characters/(-:)'
                        },
                    }
                },
                 program_id: {
                    message: 'Program code is invalid',
                    validators: {
                        notEmpty: {
