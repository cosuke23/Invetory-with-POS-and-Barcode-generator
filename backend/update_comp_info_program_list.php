...
if(isset($_GET['comp_id']) && isset($_GET['program_id']) && isset($_GET['comp_program_id'])) {
  
  $comp_id= $_GET['comp_id'];
  $program_id= $_GET['program_id'];
  $comp_program_id= $_GET['comp_program_id'];
  $query_comp_info = "SELECT a.comp_id,a.comp_name,b.program_id,c.program_code,b.comp_program_status,b.comp_program_id FROM company_info AS a INNER JOIN company_program AS b INNER JOIN  program_list AS c WHERE a.comp_id = b.comp_id AND b.program_id = c.program_id AND b.program_id  = '$program_id' AND a.comp_id = '$comp_id' AND comp_program_id = '$comp_program_id'";
          ...
          if($result2->num_rows > 0 )
            {   
              while ($row = mysqli_fetch_array($result2))
              {
                ...
                $program_id_cp = $row[2];
                $program_code = $row[3];
                $comp_program_status = $row[4];
                $comp_program_id = $row[5];
              }
           }        
}
         ...
         <!-- start: Content -->
            <div id="content">
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>UPDATE COMPANY PROGRAM</h3></div>
                     <form id="defaultForm" method="post" action="update_comp_info_program_list_process.php">
                    <br>
                     <?php
                         
                            if(isset($_GET['error']) && isset($_GET['comp_name']) && isset($_GET['program_code'])) 
                            {   
                      ...
                      <div class="panel-body" style="padding-bottom:30px;">
                          ...
                          <input name="program_id_cp" type="hidden" value ="<?php echo $program_id_cp; ?>"/>
                           <input name="comp_name" type="hidden" value ="<?php echo $comp_name; ?>"/>
                            <input name="comp_program_id" type="hidden" value ="<?php echo $comp_program_id; ?>"/>
                         <div class="row">
                         ...
                         <div class="col-md-3">
                           ...
                           <div class="col-md-3">
                            ...
                            <div class="form-group has-feedback">
                                <?php
                                $query_program_list = "SELECT * FROM program_list WHERE status = 'Active'";
                                ...
                                print'<select class="form-control"  name="program_id" class="form-control"> ';
                                 ...
                                 echo "<option value='".$program_id_cp."'>".$program_code."</option>";
                                 while($row_pl = mysqli_fetch_array($result_program_list)){
									...
									{
                                      echo $comstart."<option value='".$program_id2."'>".$program_code2."</option>".$comend;
                                     $counter++;
									}   
                                }
                                ?>
                             ...
                             <div class="col-md-3">
                                <h5 style="padding-left:5px;">COMPANY PROGRAM STATUS</h5>
                                  <div class="form-group has-feedback">
								  <?php
									...
									if($comp_program_status=="Active")
									{
										$comstart1="<!--";
									}
									else if($comp_program_status=="Not Active")
									{
										$comstart2="<!--";
									}
								  ?>
                                       <select class="form-control" name="comp_program_status" id="comp_program_status" class="form-control" placeholder="Status">
                                        <option><?php echo $comp_program_status; ?></option>
                                        <?php echo $comstart1;?><option value="Active">Active</option><?php echo $comend1;?>
                                        <?php echo $comstart2;?><option value="Not Active">Not Active</option><?php echo $comend1;?>
                                        </select>
                                  </div>
                           </div>
                        </div>
                        ...
                        <br>
                          <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-info btn-block" name="btn_comp_info_program_program_list" id="btn_comp_info_program_program_list"><span class="glyphicon glyphicon-floppy-saved"></span> &nbsp;SAVE</button>
                             </div>
                            <div class="col-md-4">
                               <a href="company_manage_program.php?comp_id=<?php echo $comp_id; ?>"><button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-chevron-left"> &nbsp;BACK</span></button></a>
                            </div>
