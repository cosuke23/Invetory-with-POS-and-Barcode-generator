...
if($usertype!=1)
{
  ...
  if((isset($_GET['acad_year_start_rd'])) && (isset($_GET['semester_rd'])) && (isset($_GET['stud_no_records'])) && (isset($_GET['comp_ojt_stud_id'])) ) {
...
$query_update_start_ojt = "SELECT a.comp_id,a.comp_ojt_stud_id,b.comp_name,DATE_FORMAT(a.ojt_start_date, '%m/%d/%Y') AS ojt_start_date FROM company_ojt_student AS a INNER JOIN company_info AS b WHERE a.comp_ojt_stud_id = '$comp_ojt_stud_id' AND a.comp_id = b.comp_id";

$result_update_start_ojt = mysqli_query($dbc,$query_update_start_ojt);
if($result_update_start_ojt->num_rows > 0)
  { 
    while($row2 = mysqli_fetch_array($result_update_start_ojt))
    {

        $c_ojt_stud_comp_id = $row2[0];
        $comp_ojt_stud_id = $row2[1];
        $c_comp_name= $row2[2];
        $ojt_start_date= $row2[3];
    }
  }
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <form id="defaultForm" method="post" action="update_start_ojt_process.php">
                      ...
                      <br>
                        ...
                        <input name="semester_rd" type="hidden" value ="<?php echo $semester_rd; ?>"/>
                          <input name="c_ojt_stud_comp_id" type="hidden" value ="<?php echo $comp_ojt_stud_id; ?>"/>
                         <div class="col-md-2">
                        ...
                        <div class="row" style="padding-left:5px;">
                         ...
                         <div class="col-md-5"> 
                           <div class="form-group has-feedback">
                              <input type="text" list="suggestion" value="<?php echo $c_comp_name;?>" class="form-control" id="comp_id"/>
                              <?php

                              $query_company_list= "SELECT a.comp_id,a.comp_name FROM company_info AS a INNER JOIN company_program AS b WHERE a.comp_id = b.comp_id AND a.status = 'Active' AND b.comp_program_status = 'Active' AND b.program_id = '$c_program_id'";
                              ...
                              ?>
								<input type="hidden" value="<?php echo $c_ojt_stud_comp_id;?>" name="comp_id-hidden" id="comp_id-hidden"/>
								<script>
                          ...
                          <div class="col-md-2"> 
                            <h5>DATE START OF OJT:</h5>
                          </div>
                          <div class="col-md-3">
                                  <div class="form-group">
                                  <div class="dateContainer">
                                      <div class="input-group input-append date" id="ojt_start_date">
                                          <input type="text" class="form-control" name="ojt_start_date" maxlength="10" value="<?php echo $ojt_start_date;?>"/>
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-4">
                             <button type="submit" class="btn btn-info btn-block" name="btn_update_start_ojt" id="btn_update_start_ojt"><span class="glyphicon glyphicon-pencil"></span> &nbsp; SAVE </button>
                             </div>
                              <div class="col-md-4">
  ...
  $('#ojt_start_date')
        .datepicker({
		 ...
		 // Revalidate the start date field
            $('#defaultForm').bootstrapValidator('revalidateField', 'ojt_start_date');
			
        FromEndDate = new Date(selected.date.valueOf());
        FromEndDate.setDate(FromEndDate.getDate(new Date(selected.date.valueOf())));
        $('.ojt_start_date').datepicker('setEndDate', FromEndDate);
    });
            ...
            fields: {
                 ojt_start_date: {
                    validators: {
                        ...
                        date: {
                            format: 'MM/DD/YYYY',
                            message: 'Invalid format of date start(e.g. MM/DD/YYYY)'
                        },
                        date: {
                            max: 'date_today',
                        },
