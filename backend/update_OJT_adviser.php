         ...
         <!-- start: Content -->
            <div id="content">
              ...
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>UPDATE OJT ADVISER INFORMATION</h3>
                         ...
                         if(isset($_GET['resend'])) 
                            ...
                            print '<div class="col-md-12">
                              <div class="alert alert-success alert-dismissible fade in" role="alert">
                                    ...
                                    <strong>&nbsp;The password has been reset to default and has been resent to the adviser`s email</strong>
                               </div></div>';
                            }
                  ?>
                     <form id="defaultForm" method="post" action="update_OJT_adviser_process.php">
                      <div class="panel-body" style="padding-bottom:30px;">
                         ...
                         <div class="col-md-2">
                            <h5 style="padding-left:5px;">ADVISER ID</h5>
                                 <div class="form-group has-feedback">
                                  <input type="text" name="adviser_id_2" id="adviser_id_2" class="form-control" placeholder="Adviser ID"  value ="<?php echo $adviser_id; ?>" disabled/>
                              </div> 
                         </div>         
                          <div class="col-md-4">
                        ...
                        <div class="row">
                          <div class="col-md-2"> 
                              ...
                              <div class="form-group has-feedback">
                							  ...
                							  ?>
                                 <select class="form-control" name="title" id="title" class="form-control" placeholder="title">
                                    <option><?php echo $title; ?></option>
                                    <?php echo $comstart3;?><option value="Mr.">Mr.</option><?php echo $comend1;?>
                                    <?php echo $comstart4;?><option value="Ms.">Ms.</option><?php echo $comend1;?>
                                    <?php echo $comstart5;?><option value="Mrs.">Mrs.</option><?php echo $comend1;?>
                                  </select>
                             </div>
                          </div>
                           <div class="col-md-3">
                             <h5 style="padding-left:5px;">LASTNAME</h5>
                              <div class="form-group has-feedback">
                                <input type="text" name="lname" id="lname" class="form-control" placeholder="last name" value ="<?php echo $lname ; ?>" maxlength="32"/>
                               </div>
                            </div>
                          <div class="col-md-3">
                            <h5 style="padding-left:5px;">FIRSTNAME</h5>
                              <div class="form-group has-feedback">
                                <input type="text" name="fname" id="fname" class="form-control" placeholder="first name" value ="<?php echo $fname; ?>" maxlength="32"/>
                               </div>
                          </div>
                          <div class="col-md-2">
                            <h5 style="padding-left:5px;">MIDDLENAME</h5>
                              <div class="form-group has-feedback">
                                  <input type="text" name="mname" id="mname" class="form-control" placeholder="middle name"  value ="<?php echo $mname; ?>" maxlength="32"/>
                              </div>
                          </div>
                          <div class="col-md-2">
                        ...
                        <br>
                          <div class="row">
                            <div class="col-md-4">
                              <a href="adv_reset_resend_pass.php?username=<?php echo $adviser_id; ?>"><button class="btn btn-warning" type="button" >Reset and Resend Default Password</button></a>
                            </div>
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-info btn-block" name="btn-adviser-update" id="btn-adviser-update"><span class="glyphicon glyphicon-floppy-saved"></span> &nbsp;SAVE</button>
                             </div>
                             <div class="col-md-4">
