...
if($usertype!=1)
{
  ...
  $query_update_program_category_list = "SELECT a.program_id,a.category_id,a.category_description,a.ojt_hours,a.status,b.program_code FROM program_category_list AS a INNER JOIN program_list AS b WHERE a.program_id = b.program_id AND a.category_id = '$category_id' ";
                 
  $result_update_program_category_list =  mysqli_query($dbc, $query_update_program_category_list);          
          if($result_update_program_category_list->num_rows > 0 )
            {   
              while ($row = mysqli_fetch_array($result_update_program_category_list))
              {
                   $program_id_pcl = $row[0];
                   $category_id = $row[1];
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">OJT CATEGORY LIST</h1>
                        <p class="animated fadeInDown" style="padding-left:10px;">
                          This section will show the information and the list for ojt category.
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>UPDATE OJT CATEGORY LIST</h3></div>
                     <form id="defaultForm" method="post" action="update_program_category_list_process.php">
                      <div class="panel-body" style="padding-bottom:30px;">
                        <input name="category_id" type="hidden" value ="<?php echo $category_id; ?>" />
                        <input name="program_id_pcl" type="hidden" value ="<?php echo $program_id_pcl; ?>" />
                           <br>
                           <br>
                            <div class="row">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-3">
                             ...
                             <div class="col-md-4">
                                <div class="form-group has-feedback">
                                  <input type="text" name="category_description" id="category_description" class="form-control" placeholder="Category Description" value="<?php echo $category_description ; ?>"  maxlength="100"/>
                                </div>
                              </div>
                               <div class="col-md-4"></div>
                          </div>
                          <br>
                           <div class="row">
                            ...
                            <div class="col-md-3">
                             ...
                             <div class="col-md-4">
                                <div class="form-group has-feedback">
                                  <input type="text" name="ojt_hours" id="ojt_hours" class="form-control" placeholder="OJT Hours" value="<?php echo $ojt_hours ; ?>"  maxlength="4"/>
                                </div>
                              </div>
                               <div class="col-md-4"></div>
                          </div>
                         ...
                         <div class="row">
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                  <button type="submit" class="btn btn-info btn-block" name="btn_update_program_category_list" id="btn_update_category_list"><span class="glyphicon glyphicon-floppy-saved"></span> &nbsp;SAVE</button>
                            </div>
                            <div class="col-md-4">
                                 <a href="program_category_list.php"><button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-chevron-left"> &nbsp;BACK</span></button></a>
                            </div>
                          </div>
                          <br>
 ...
 $('#datatables').DataTable();
   $('#defaultForm')
        .bootstrapValidator({
            ...
            regexp: {
                            regexp: /^[0-9]+$/,
                            message: 'OJT hours can only consist of numbers'
                        },
            stringLength: {
                            min: 3,
                            max: 4,
                            message: 'OJT hours can be more than  3 and less than 4 numbers'
                        },
                    }
                },
               category_description: {
                    message: 'OJT description is not valid',
                    validators: {
                        notEmpty: {
                ...
                stringLength: {
                            min: 5,
                            max: 80,
                            message: 'OJT hours can be more than 5 and less than 80 alphanumeric characters'
                        },
                regexp: {
                            regexp: /^[a-zA-Z 0-9 -:]+$/,
                            message: 'Invalid characters. OJT description can only consist of alphanumeric characters/(-:)' 
                        },
                    }
                },
                 program_id: {
