					   ...
					   <input type="hidden" name="sub_date" value="<?php echo $sub_date;?>"/></div>
						   <div class="col-md-4">
								...
								if(isset($_POST['btn2']) && isset($_GET['stud_no']))
								{
									...
									$query_3="SELECT COUNT(endorsement_id) AS en_count FROM endorsement WHERE comp_id='$comp_id2'";
